                ...
                <div className="flex flex-col gap-2 sm:gap-3 w-full mt-4">
                  {semesters.map((sem) => (
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      className={`px-2 py-2 sm:px-3 sm:py-2 rounded-full text-[10px] sm:text-xs md:text-sm font-semibold ${activeSemester === sem ? "bg-[#38A169] text-white shadow" : "bg-white text-[#38A169]  border-[#38A169] border-dashed border-2"}`}
                    >
                      {sem}
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    className="
                      mt-22 w-full bg-[#4D964F] text-white px-3 py-2 sm:py-3
              ...
              <div className="flex flex-col w-full gap-4 mt-10 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    className={`w-full px-4 py-3 rounded-full font-semibold ${activeSubject === sub.id ? "bg-[#38A169] text-white shadow" : "bg-white text-[#38A169] border-[#38A169] border-dashed border-2"}`}
                  >
                    {sub.name}
                  </motion.button>
                ))}
            ...
            <div className="flex flex-col gap-4 w-full xl:w-[90%]">
              {semesters.map((sem) => (
                <motion.button
                  ...
                  onClick={() => setActiveSemester(sem)}
                  whileHover={{ scale: 1.05 }}
                  className={`px-4 py-3 rounded-full font-semibold ${activeSemester === sem ? "bg-[#38A169] text-white shadow" : "bg-white text-[#38A169] border-[#38A169] border-dashed border-2"}`}
                >
                  {sem}
                  {semSuffix[sem]} Semester
                </motion.button>
