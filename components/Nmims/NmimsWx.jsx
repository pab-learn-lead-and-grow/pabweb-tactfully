      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-left text-[#345895] text-lg md:text-xl max-w-3xl mx-auto leading-relaxed mb-14"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-linear-to-b from-[#345895] to-[#101C2F] text-white p-8 md:p-12 rounded-3xl shadow-xl max-w-4xl mx-auto"
          >
      ...
      "
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                viewport={{ once: true }}
                className="grid grid-cols-[30px_auto] gap-3 items-start"
              >
