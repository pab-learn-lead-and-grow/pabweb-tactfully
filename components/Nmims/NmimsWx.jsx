        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            <MotionWrapper
              ...
              viewport={{ once: true }}
              className="text-white text-[20px] md:text-[32px] lg:text-5xl xl:text-[56px] font-sans font-bold mt-1 leading-tight"
            >
              NMIMS Executive MBA : Fees, Eligibility & Admission Dates 2026
            </MotionWrapper>
    ...
    px-2 py-2 md:px-6 md:py-3 whitespace-nowrap rounded-lg hover:bg-yellow-600 transition-all duration-300 font-medium"
            ...
            >
              ...
              <MotionWrapper
                ...
                className=" bg-linear-to-b from-[#270652] to-[#3C087E]/50 
                     text-white w-[200px] h-[285px] md:w-[260px] rounded-2xl shadow-xl p-8 flex flex-col mt-10 items-center"
              >
      ...
      <section className="w-full bg-white px-4 md:px-12 lg:px-20 py-16 font-sans">
        ...
        <MotionWrapper
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-[#270652] font-bold text-3xl sm:text-4xl md:text-5xl font-sans lg:text-5xl xl:text-[64px] leading-tight mb-12 w-full"
        >
