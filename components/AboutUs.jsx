      ...
      >
        ...
        ">
          <Image
            ...
            width={240}
            height={200}
            className="w-[140px] md:w-[160px] lg:w-full lg:p-6 h-auto object-contain"
          />
        </div>
      </motion.div>
      ...
      >
        ...
        ">
          <Image
            ...
            width={420}
            height={320}
            className="w-[160px] md:w-[200px] lg:w-full lg:p-6 h-auto object-contain"
          />
        </div>
      </motion.div>
    </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14">
          ...
          >
            ...
            <div>
              ...
              <p className="text-black text-xs md:text-lg lg:text-[15px] xl:text-[22px] leading-tight max-w-md">
