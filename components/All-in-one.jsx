...
export default function AllInOneSection() {
  ...
  <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 bg-white text-center">
    ...
    {/* Heading */}
    <h2
      className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#345895]
                 text-center whitespace-nowrap mx-auto"
    >
      All-in-one space that's got your back, always
    </h2>
...
function IconCard({ title, image }) {
  return (
    <div className="w-28 md:w-32 flex flex-col items-center text-center">
      ...
      {/* ICON BOX */}
      <div
        className="group relative w-full aspect-square bg-white rounded-3xl border border-[#345895]
                   shadow-[8px_8px_0px_#345895] 
                   hover:shadow-[14px_14px_0px_#345895]
