...
export default function Page() {
  ...
  const faqs = [
    {
      q: "How long is the Online MA in Economics, and how is it delivered?",
    ...
    },
    {
      ...
      a: "Applicants must hold a bachelor’s degree from a recognised university. No prior work experience is required.",
    },
    {
      q: " What elective subjects can I choose from?",
      a: "Learners can pick from a variety of electives such as Health Economics, Behavioural Economics, Labour Economics, International Finance, and Environmental Economics.",
    },
    {
      q: " How will classes and study materials be provided?",
      a: "Students learn via live online sessions, recorded lectures, e-resources, discussion forums, and assessments—accessible anytime through the LMS.",
    },
    {
      q: "Are assessments and exams conducted online?",
      a: "Yes. All evaluations, including assignments, quizzes, project work, and term-end exams, are held online.",
    },
  ];
      ...
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <motion.span
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 bg-[#4d964f] text-white text-[18px] sm:text-[18px] mt-6 mb-2 px-4 py-2 rounded-full"
          >
            4.8 <Star size={15} />
          </motion.span>
          ...
          <div className="flex flex-col items-start">
            <motion.h1
              ...
              viewport={{ once: true }}
              className="text-white text-4xl sm:text-5xl md:text-5xl font-[Inter] lg:text-[60px] font-bold -mt-2 leading-tight"
            >
              Online Master of Arts(MA) in Economics
            </motion.h1>
            ...
            >
              The Online MA in Economics from MUJ builds future-ready policy and economics expertise with topics like public economics, game theory, and environmental economics. Delivered via a 24/7 LMS with live/recorded classes, it also includes Coursera access for industry certifications.
            </motion.p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
              viewport={{ once: true }}
              className="grid grid-cols-2 mt-5 md:grid-cols-4 -mx-8 gap-y-6 w-6xl"
            >
              {stats.map((stat, idx) => (
                <div
                  key={idx}
                ...
                >
                  <p className="text-3xl sm:text-4xl md:text-5xl font-[Inter] font-bold text-white whitespace-nowrap mb-1">
                    {stat.value}
                  </p>
        ...
        <div className="max-w-232 text-left mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal text-[40px] leading-snug text-gray-900">
            <span className="text-[#F26722] ">
              MUJ’s online MA in Economics prepares learners with the analytical and policy-focused skills required in today’s dynamic economic landscape. {" "}
            </span>
         Guided by expert faculty, the curriculum spans key areas such as public economics, health economics, game theory, and environmental economics. The program is delivered through an advanced LMS offering round-the-clock access to study materials, recorded and live classes, forums, and quizzes. Indian learners also benefit from exclusive Coursera access to earn certificates in high-demand skill areas.
          </h2>
        </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div>
              <h3 className="text-lg text-[#064E92] mb-1">
                	In-Depth Understanding Of Economic Policies
              </h3>
              <p className="text-gray-700 text-sm leading-relaxed">
              	Explore the world of economics in depth with a robust curriculum featuring subjects such as microeconomics, development economics, game theory, the history of economic thought, the international financial system, and other essential areas.
              </p>
            </div>
          </div>
      ...
      semesters: {
        ...
        semester4: {
          ...
          topics: [
            ...
            "Monetary Economics",
            "Operation Research in Economics",
            "Dissertation",
          ],
          ...
          specialization: {
            ...
            data: [
              ...
              {
                name: "Economics of Human Development",
                topics: ["Economics of Human Development"],
              },
              {
                name: "International Financial System",
                topics: ["International Financial System"],
              },
            ],
          },
        },
...
/>
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <div className="mb-5">
            ...
            <p className="text-[#1F284E] text-[32px] mb-5 list-disc px-5 leading-tight">
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Manipal University Jaipur Online MA follows a structured and
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-5">
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Build the expertise required to pursue a rewarding
                  policymaking career and stand out in a competitive landscape.
                  Unlock diverse opportunities in finance, academia, government,
                  public administration, and related sectors.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h3 className="text-black text-lg md:text-xl font-extrabold mb-2">
                  Global network and access to alumni
                </h3>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Engage with peers, alumni, and industry leaders to understand
                  worldwide market trends and challenges. Become part of MUJ’s
                  esteemed alumni community.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              ...
              <div>
                <h3 className="text-black text-lg md:text-xl font-extrabold mb-2">
                  Build a career in public policy
                </h3>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Build the skills needed to thrive in public policy by learning
                  econometrics, quantitative analysis, research techniques, and
                  sector-wide trend forecasting.{" "}
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Learn entirely online with high-quality classes, assessments,
                  and placement support. Dedicated mentors and 24/7 student help
                  ensure you're supported at every step.
                </p>{" "}
              </div>
            </motion.div>
          </div>
