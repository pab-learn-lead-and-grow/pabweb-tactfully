 ...
 const topFaculty = [
  ...
  return (
    ...
    <section className="relative min-h-[50vh] w-full ">
                               ...
                               {/* Most Loved */}
                                ...
                                <div className="flex flex-col items-start">
                                  <motion.h1
                                    ...
                                    viewport={{ once: true }}
                                    className="text-white text-3xl md:text-4xl lg:text-5xl xl:text-[56px] font-[Inter] font-bold mt-1 leading-tight"
                                  >
      ...
      <WhyChooseUs title="Why Choose MUJ Online MA" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
