                               ...
                               {/* Most Loved */}
                                ...
                                <div className="flex flex-col items-start">
                                  ...
                                  as="h1"
                                    ...
                                    viewport={{ once: true }}
                                    className="text-white text-3xl md:text-4xl lg:text-5xl xl:text-[56px] font-sans font-bold mt-1 leading-tight"
                                  >
...
<CounsellingModal>
  ...
  >
    ...
    <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
                       ...
                       {/* ======= SNAPSHOT SECTION ======= */}
                                 <section className="w-full xl:mt-16  px-4 md:px-10 lg:px-20 font-sans">
      ...
      <WhyChooseUs title="Why Choose MUJ Online MA" cards={whyCards} />

      <CourseCurriculumSection
      title="MUJ Online MA Syllabus"
  years={[1, 2]}
  data={{
    1: {
      semesters: {
...
/>
         ...
         <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
           ...
           <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
             <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
               Fees Structure for MUJ Online MA
             </h2>
      ...
      />
         ...
         <section className="w-full flex items-center justify-center pt-10 px-6 md:px-18">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center font-sans lg:gap-20">
            ...
            "
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                          Engage with peers, alumni, and industry leaders to understand worldwide market trends and challenges. Become part of MUJ’s esteemed alumni community.
                        </p>
                      </div>
                    </MotionWrapper>
        ...
        "
            ...
            "
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                          Build the expertise required to pursue a rewarding policymaking career and stand out in a competitive landscape. Unlock diverse opportunities in finance, academia, government, public administration, and related sectors.
        ...
        "
            ...
            "
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                          Build the skills needed to thrive in public policy by learning econometrics, quantitative analysis, research techniques, and sector-wide trend forecasting.
                        </p>
                      </div>
                    </MotionWrapper>
