      ...
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
             The Online MCom from MUJ equips learners with essential business and finance skills through a flexible curriculum, live/recorded classes, Coursera certifications, and placement support to accelerate their careers in the evolving business landscape.  </motion.p>
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-232 text-left mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal text-[40px] leading-snug text-gray-900">
            ...
            Delivered via an advanced online platform with live/recorded classes, e-libraries, forums, and online exams, the program also offers Coursera certifications, placement support, and Manipal Alumni status to enhance career growth. </h2>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
            ...
            <h2 className="text-[#345895] text-[46px] md:text-[52px] lg:text-[62px] font-bold leading-[1.05] max-w-[720px]">
              ...
              <span className="block">M.COM Certificate</span>
            </h2>
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                through online tools, certifications, and industry interactions                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="w-18 h-18 bg-[#345895] rounded-full flex items-center justify-center">
                <BriefcaseBusiness size={35} strokeWidth={1.0} className="text-white" />
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                 with structured career support and placement services </p>
            </div>
            </motion.div>
