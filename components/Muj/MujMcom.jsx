...
export default function Page() {
  ...
  const faqs = [
    {
      q: "How long is the Online M.Com program, and how is it delivered?",
      a: "The program is two years long (four semesters) and is offered fully online through MUJ’s digital learning platform.",
    },
    {
      q: "What qualifications do I need to apply?",
      a: "You must hold a bachelor’s degree (10+2+3 or equivalent) from a recognised university to be eligible for admission.",
    },
    {
      q: "  Do applicants need work experience to join the program?",
      a: "No. The Online M.Com is open to fresh graduates and does not require prior work experience.",
    },
    {
      q: " What subjects are included in the Online M.Com curriculum?",
      a: "The program covers a wide range of commerce and business subjects, including cost analysis, corporate taxation, international business, e-commerce, financial management, accounting, auditing, and risk management.",
    },
    {
      q: "How are classes and assessments conducted online?",
      a: "Learners attend live and recorded sessions, access e-libraries, participate in discussions, and complete assignments and examinations entirely through the online learning portal.",
    },
  ];
    ...
    <section className="relative min-h-[50vh] w-full ">
                                              ...
                                              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                                               {/* Most Loved */}
                                                                                        ...
                                                                                        >
                                                                                          4.2 <Star  className="w-3 h-3 md:w-4 md:h-4"/>
                                                                                        </MotionWrapper>
                                                ...
                                                <div className="flex flex-col items-start">
                                                  <MotionWrapper
                                                    ...
                                                    viewport={{ once: true }}
                                                    className="text-white text-3xl md:text-4xl lg:text-5xl xl:text-[64px] font-sans font-bold mt-1 leading-tight"
                                                  >
                                                 Manipal University Jaipur Online MCOM
                                                  ...
                                                  >
                                               The Online MCom from MUJ equips learners with essential business and finance skills through a flexible curriculum, live/recorded classes, Coursera certifications, and placement support to accelerate their careers in the evolving business landscape.
                                                </MotionWrapper>
...
<CounsellingModal>
  ...
  >
    ...
    <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
                      ...
                      <section className="w-full bg-white p-10 py-12 flex flex-col lg:mb-20 gap-12">
                        ...
                        <div className="max-w-6xl text-left mx-auto">
                          <h2 className="text-xl md:text-2xl font-regular lg:text-[42px] leading-normal text-gray-900">
                           ...
                           The Online MCom from Manipal University Jaipur (MUJ) prepares learners to accelerate their careers with strong expertise in cost analysis, corporate tax planning, international business, and e-commerce.
                           </span>
                            Delivered via an advanced online platform with live/recorded classes, e-libraries, forums, and online exams, the program also offers Coursera certifications, placement support, and Manipal Alumni status to enhance career growth.
                             </h2>
                        </div>
                          ...
                          <div className="flex flex-col gap-4 p-4 sm:p-6">
                            ...
                            <div>
                              <p className="lg:text-2xl text-[#270652] mb-1">
                                		Fully online experience with campus immersion
                              </p>
                              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
                            		Enjoy a complete online learning experience with seamless enrollment, coursework, assessments, and placement services. Benefit from 24×7 support and dedicated mentors, and take part in special campus events to interact with classmates and faculty.
                                 </p>
                            </div>
                          </div>
      ...
      <WhyChooseUs title="Why Choose MUJ Online MCOM" cards={whyCards}  />

  <CourseCurriculumSection
  title="MUJ Online MCOM Syllabus"
  years={[1, 2]}
  data={{
    1: {
      semesters: {
...
/>
        ...
        <div className="p-6 md:p-10">
          {/* Heading */}
           <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for MUJ Online MCOM
          </h2>
     ...
     <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-sans relative">
                         ...
                         <div className="max-w-6xl mx-auto relative">
                           ...
                           >
                             The Manipal University Jaipur Online MCom follows a structured and
