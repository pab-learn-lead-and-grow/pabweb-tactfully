...
export default function Page() {
  ...
  const faqs = [
    ...
    {
      q: " Are online MBA classes more affordable than regular MBA classes?",
      a: "Yes, they are more affordable because of lower tuition and no relocation or living expenses. With flexible payment options, they are more affordable.",
    },
    {
      q: "Can an online MBA degree get you a job?",
      a: "Yes, online master's degrees offered by Manipal University Jaipur are tailored for industry requirements, equipping you with theoretical knowledge and practical skills that employers seek, besides being job ready.",
    },
    {
      q: "Are online degrees by Online Manipal credible and valid?",
      a: "Yes, all online degree programs offered through Online Manipal are UGC-entitled, making them equivalent to on-campus degrees.",
    },
    {
      q: "Is this online MBA program compliant with AICTE norms?",
      a: "Yes, this MBA program is compliant with AICTE norms. However, as per the University Grants Commission (UGC), Central, State and Private Universities offering Undergraduate, Postgraduate & Postgraduate Diploma programs under the disciplines of Management, Computer Applications and Travel & Tourism in online mode do not require AICTE approval.",
    },
  ];
  ...
  const stats = [
    ...
    { value: "Super/Dual", label: "Specialization" },
  ];
  return (
      ...
      <section className="relative min-h-[50vh] w-full ">
                                   ...
                                   <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                                    {/* Most Loved */}
                                                                             ...
                                                                             >
                                                                               4.9 <Star  className="w-3 h-3 md:w-4 md:h-4"/>
                                                                             </MotionWrapper>
                                     ...
                                     <div className="flex flex-col items-start">
                                       ...
                                       >
                                      Step into the future of work with the UGC-entitled Online MBA from Manipal University Jaipur (NAAC A+ & QS-ranked). Choose from 13 specializations, including Digital Marketing and Data Science, with the option for super or dual specialization in Semester 3. Gain Coursera access, industry certificates, placement support, and the strength of the global Manipal Alumni network.
                                       </MotionWrapper>
...
<CounsellingModal>
 ...
 <section className="w-full bg-white py-10 px-4 lg:px-10 pt-0">
      ...
      <section className="w-full bg-white p-10 py-12 flex flex-col lg:mb-20 gap-12">
        ...
        <div className="max-w-6xl text-left mx-auto">
          <h2 className="text-xl md:text-2xl font-regular lg:text-[40px] leading-normal text-gray-900">
            ...
            The program features 13 career-focused specializations from Digital
            Marketing to Analytics & Data Science. In the third semester, you
            can choose between a super specialization for deep domain expertise
            or a dual specialization to broaden your skillset. This fully online
            MBA also includes exclusive Coursera access to earn industry
            certificates in high-growth fields. Strengthen your career outcomes
            with placement support and benefit from the extensive Manipal Alumni
            network.
          </h2>
        </div>
      ...
      <WhyChooseUs title="Why Choose MUJ Online MBA" cards={whyCards}  />

      <CourseCurriculumSection
      title="MUJ Online MBA Syllabus"
        years={[1, 2]}
        data={{
          1: {
            semesters: {
      ...
      <section className="w-full font-sans px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for MUJ Online MBA
          </h2>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for MUJ Online MBA
              </h2>
      ...
      },
      {
        ...
        sub: "per month [Terms & Conditions apply]",
            ...
            <CounsellingModal>
            <button className="lg:hidden text-white bg-[#F6A410] border-0 border-transparent font-medium px-6 py-2 rounded-md shadow-md transform hover:scale-105 duration-200 w-fit mx-auto mt-3">
              Compare all Plans
            </button>
            </CounsellingModal>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center font-sans lg:gap-20">
          ...
          <div className="space-y-5">
            ...
            <p className="text-[#3C3C43] max-w-[350px] text-base">
              Graduate with UGC-entitled and internationally accepted online
              degrees.
            </p>
      ...
      <section className="w-full bg-white mt-10 lg:mt-20 px-4 md:px-12 lg:px-20 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-5">
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              <div className="shrink-0 w-18 h-18 md:w-14 md:h-14 lg:w-18 lg:h-18 bg-[#270652] rounded-full flex items-center justify-center">
                <UserLock
                  strokeWidth={1.0}
                  className="text-white w-8 h-8 md:w-8 md:h-8 lg:w-9 lg:h-9"
                />
              </div>
          ...
          >
            ...
            <div className="text-center md:mb-4 pb-3">
              ...
              as="h2"
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className="text-[#270652] font-bold font-sans text-[32px] md:text-5xl lg:text-[64px] leading-tight"
              >
