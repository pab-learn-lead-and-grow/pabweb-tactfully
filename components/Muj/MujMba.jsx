        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:10">
          ...
          <div className="flex flex-col items-start">
            <motion.h1
              ...
              viewport={{ once: true }}
              className="text-white text-4xl  md:text-5xl font-[Inter] lg:text-[54px] xl:text-[64px] font-bold -mt-1 leading-tight"
            >
      ...
      <section className="w-full bg-white mt-20 px-4 md:px-12 lg:px-20 py-16 font-[Inter]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-5">
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              <div className="shrink-0 w-18 h-18 md:w-14 md:h-14 lg:w-18 lg:h-18 bg-[#345895] rounded-full flex items-center justify-center">
                <UserLock
                  strokeWidth={1.0}
          ...
          >
            ...
            <div className="text-center md:mb-4 pb-3">
              <motion.h2
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className="text-[#345895] font-bold font-[Inter] text-[32px] md:text-5xl lg:text-[64px] leading-tight"
              >
       ...
       "
              ...
              >
                ...
                <motion.button
                  ...
                  className="w-[200px] mt-6 py-3 px-6 rounded-lg text-white text-sm bg-linear-to-r from-[#4D964F] to-[#193019] shadow-md shadow-[#1C361D]/40"
                >
                  Know more
                </motion.button>
              </motion.div>
