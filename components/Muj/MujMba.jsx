...
export default function Page() {
  ...
  return (
    <main className="flex flex-col items-center w-full bg-white">
      ...
      <WhyChooseUs title="Why Choose MUJ Online MBA" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
       ...
       "
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  onClick={() => setIsModalOpen(true)}
                  className="w-[200px] mt-6 py-3 px-6 rounded-lg text-white text-sm self-center md:self-start bg-[#F6A410] shadow-lg"
                >
                  Know more
                </motion.button>
              </motion.div>
