      ...
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              The Online MA in Journalism & Mass Communication from MUJ trains
              learners in digital publishing, AV editing, scriptwriting, and
              photography through flexible learning. It offers Coursera
              certifications, key media concepts, and 100% placement assistance.{" "}
            </motion.p>
        ...
        <div className="max-w-232 text-left mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal text-[40px] leading-snug text-gray-900">
            <span className="text-[#F26722] ">
              MUJ’s online MA in Journalism and Mass Communication equips
              learners with the skills needed to excel in today’s dynamic media
              industry.{" "}
            </span>{" "}
            This two-year online degree offers practical learning in digital
            writing, publishing, editing, screenwriting, and photography. With
            guidance from expert faculty, students can master news reporting,
            broadcast journalism, digital media marketing, and film appreciation
            without interrupting their careers. Learners in India also gain
            access to Coursera certifications and dedicated placement support.{" "}
          </h2>
        </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Gain core journalism abilities—including digital literacy, AV
                editing, scriptwriting, research, and reporting—by studying
                subjects like media language, digital publishing, photography
                fundamentals, development communication, and broadcast
                journalism.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
            ...
            <h2 className="text-[#345895] text-[46px] md:text-[52px] lg:text-[62px] font-bold leading-[1.05] max-w-[720px]">
              ...
              <span className="block">MA-JMC Certificate</span>
            </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-5">
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              ...
              <div>
                <h3 className="text-black text-lg md:text-xl font-extrabold mb-2">
                  Choose career oriented learning path
                </h3>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Build skills that align with your professional interests. Master print, audio, and video production, along with website management, and get hands-on exposure to key beats such as social, political, cultural, business, sports, and science.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h3 className="text-black text-lg md:text-xl font-extrabold mb-2">
                  Cross industry contacts and alumni access
                </h3>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Network with diverse peers, media experts, and industry leaders to advance your career. Benefit from MUJ’s extensive and active alumni community.                </p>
              </div>
            </motion.div>
          </div>
