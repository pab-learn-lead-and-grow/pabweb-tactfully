 ...
 const blogs = [
  ...
  return (
    <section className="w-full flex flex-col font-[Inter] items-center bg-white">
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 xl:grid-cols-[8%_68%_24%] gap-5 mt-20 md:mt-10 lg:mt-0 xl:mt-20 px-4 ">
        {/* LEFT SOCIAL ICONS */}
        <div
          className="
  ...
  "
        ...
        <MotionWrapper
          ...
          className="bg-white shadow p-8 flex flex-col gap-6 md:mb-10 rounded-t-2xl lg:-mt-35 md:-mt-10"
        >
          ...
          <RelatedBlogs blogs={blogs} />
            ...
            <section className="w-full mt-8 md:mt-16  px-4 md:px-10 lg:px-20 font-[Inter]">
                                         <div className="max-w-7xl mx-auto">
                                           ...
                                           >
                                             Best UGC-Approved Universities for Online Degrees
                                           </MotionWrapper>
                                         </div>
                                       </section>
