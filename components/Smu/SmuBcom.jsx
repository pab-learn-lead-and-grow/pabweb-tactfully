      ...
      <section className="relative min-h-[50vh] w-full ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              Sikkim Manipal University’s affordable online BCom offers
    ...
    px-2 py-2 md:px-6 md:py-3 whitespace-nowrap rounded-lg hover:bg-yellow-600 transition-all duration-300 font-medium"
      ...
      <section className="w-full bg-white p-10 py-12 flex flex-col lg:mb-20 gap-12">
        ...
        <div className="max-w-6xl text-left mx-auto">
          <h2 className="text-xl md:text-2xl font-regular lg:text-[42px] leading-normal text-gray-900">
            <span className="text-[#B35531] ">
              The online Bachelor of Commerce (BCom) from Sikkim Manipal
              University (SMU) is designed to help learners delve into the world
              of business and commerce.{" "}
            </span>
            The industry aligned curriculum of this online BCom program equips
            learners with strong foundations in various levels of accounting
            such as financial, corporate accounting, cost, and management while
            covering other core areas such as taxation, HRM, investments,
            auditing, statistics, and mathematics. Delivered by experienced
            faculty through an AI-enabled platform, learners can access learning
            resources, live and recorded classes, discussion forums,
            e-libraries, AI-tutor, and quizzes from the comfort of their homes.
            This program offers a highly affordable pathway to an online BCom
            degree you can complete from home.
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            <div>
              <p className="lg:text-2xl text-[#270652] mb-1">
                Comprehensive Commerce Foundation with Multi-Disciplinary
                Business Skills
              </p>
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
                The program delivers a robust curriculum spanning accounting,
                finance, taxation, business law, commerce, economics, and
                business mathematics - equipping you with a solid, versatile
                grounding to tackle complex business problems and succeed across
                finance, management, marketing, and HR roles.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 ">
            ...
            <div>
              <p className="lg:text-2xl text-[#270652] mb-1">
                Flexible 100% Online Format with UGC-Entitled Degree & Strong
                Value for Money
              </p>
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
                SMU’s online B.Com allows you to study fully online - attend
                classes, complete assignments, and take exams from anywhere,
                making it ideal for working students or those with other
                commitments. As a UGC-entitled program from a NAAC A+ accredited
                university, it combines flexibility and recognition with
                affordable fees and semester-wise payment options.
              </p>
            </div>
          </div>
        </div>
      </section>
      <WhyChooseUs title="Why Choose SMU Online BCOM" cards={whyCards} />

      <CourseCurriculumSection
        title="SMU Online BCOM Syllabus"
        years={[1, 2, 3]}
        data={curriculumData}
      />
      <section className="w-full font-sans px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for SMU Online BCOM
          </h2>
          ...
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] px-5 list-disc md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              ...
              <li>
                ...
                of Indian Universities. Candidates who have completed 10+2
                education or graduate level education outside India must produce
                a certificate of equivalence issued by the Association of Indian
                Universities.
              </li>
            </ul>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-sans relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Sikkim Manipal Online BCom follows a structured and transparent
      ...
      <section className="w-full flex items-center justify-center pt-10 px-6 md:px-18">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-sans lg:gap-20">
          {/* LEFT CONTENT */}
          ...
          <div className="flex flex-col gap-12">
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Get a comprehensive grounding in subjects like accounting,
                  finance, taxation, business law, economics, and business
                  mathematics - building a versatile base for finance, business,
                  management, or entrepreneurial careers.
                </p>
              </div>
            </MotionWrapper>
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Study entirely online with live/recorded lectures, digital
                  resources, assignments, and exams - giving you the freedom to
                  learn from anywhere at your own pace without disrupting your
                  routine.
                </p>
              </div>
            </MotionWrapper>
          ...
          <div className="flex flex-col gap-12">
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Gain practical, up-to-date knowledge of current commerce and
                  business practices, making you ready to step into dynamic
                  environments across banking, finance, accounting, e-commerce,
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  Earn a UGC-entitled bachelor’s degree from a NAAC A+
                  accredited university, which holds value for employment,
                  higher studies, or professional courses - boosting your
