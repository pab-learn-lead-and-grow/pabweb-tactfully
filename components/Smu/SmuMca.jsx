  ...
  const topFaculty = [
    {
      ...
      image: "/smu/faculties/sourav.png",
    },
    {
      name: "Mrs. Joyashri Basak",
      title: "Assistant Professor",
      image: "/smu/faculties/joyashri.png",
    },
  ];

  const bottomFaculty = [
    {
      name: "Dr. khushal Pokhrel",
      title: "Assistant Prof. & Deputy Director",
      image: "/smu/faculties/khushal.png",
    },
    {
      name: "Mr. Arpan Gautam",
      title: "Assistant Professor",
      image: "/smu/faculties/arpan.png",
    },
    {
      name: "Mr. Tirupathi Bhattacharya",
      title: "Assistant Professor",
      image: "/smu/faculties/tirupathi.png",
    },
    {
      name: "Mr. Arun Chaudhary",
      title: "Assistant Professor",
      image: "/smu/faculties/arun.png",
    },
  ];
    ...
    <section className="relative min-h-[50vh] w-full ">
                                                       ...
                                                       <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                                                        {/* Most Loved */}
                                                                                                 ...
                                                                                                 >
                                                                                                   4.6 <Star  className="w-3 h-3 md:w-4 md:h-4"/>
                                                                                                 </motion.span>
                                                         ...
                                                         Sikkim Manipal Online MCA
                                                           ...
                                                           >
                                                          Become a future-ready IT professional with Sikkim Manipal University’s affordable online MCA, powered by an AI-enabled learning system offering live/recorded classes, peer & faculty interaction, industry-relevant skills, online exams, and access to the prestigious SMU alumni network - all without leaving your job.
                                                           </motion.p>
      ...
      <section className="w-full bg-white p-10 py-12 flex flex-col lg:mb-20 gap-12">
        ...
        <div className="max-w-6xl text-left mx-auto">
          <h2 className="text-xl md:text-2xl font-regular lg:text-[42px] leading-normal text-gray-900">
            <span className="text-[#B35531] ">
              Become a future-ready IT professional with an online Master of Computer Applications (MCA) from Sikkim Manipal University (SMU).{" "}
            </span>
            Delivered through an AI-enabled learning management system, this affordable online MCA program equips learners with trending skills in computer applications, programming languages, artificial intelligence, and deep learning. The program enables learners to attend live and recorded classes, interact with peers and faculty through discussion forums, write online proctored exams, and build a professional network without quitting their full-time jobs. Join the prestigious SMU alumni network upon successful completion of the program.
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            <div>
              ...
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
               SMU’s online MCA equips you with advanced technical skills in programming, software development, AI, cloud computing, data analytics, and more. The curriculum covers modern technologies, programming languages, and emerging tools - preparing you to succeed across a range of IT roles.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 ">
            ...
            <div>
              <p className="lg:text-2xl text-[#270652] mb-1">
               Flexible, Fully Online Delivery - Ideal for Working Professionals
              </p>
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
               The program is delivered 100% online via an AI-enabled learning platform, with live/recorded classes, virtual labs, digital libraries, remote proctored exams, and 24/7 access. This flexibility lets you continue working or manage personal commitments while upgrading your skills.
              </p>
            </div>
          </div>
        </div>
      </section>
      <WhyChooseUs title="Why Choose SMU Online MCA" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />

        <CourseCurriculumSection
        title="SMU Online MCA Syllabus"
  years={[1, 2]}
  data={{
    /* -------------------------------- YEAR 1 -------------------------------- */
    1: {
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for SMU Online MCA
          </h2>
          ...
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] px-5 list-disc md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              <li>
                  Candidates must have completed 10+2+3-year bachelor’s degree in Computer Applications/Computer Science/Information Technology from a recognized university/institution, or an equivalent qualification as recognized by the Association of Indian Universities (AIU) or other competent bodies
              </li>
               <li>
                  Candidates who have completed 10+2+3-year bachelor’s degree from other streams like Science, Business Administration, Business Management, Arts & Humanities, Commerce, etc. are also eligible for MCA admission but they have to attend and complete a compulsory bridge course in fundamentals of computer and IT along with their Semester 1 courses. Additionally, candidates who have not studied mathematics during their 10 + 2/ bachelor’s degree programs must attend and complete a compulsory bridge course in mathematics along with other semester 1 courses.
               </li>
            </ul>
      ...
      />
       ...
       <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
                               ...
                               <div className="max-w-6xl mx-auto relative">
                                 ...
                                 >
                                   The Sikkim Manipal Online MCA follows a structured and
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for SMU Online MCA
              </h2>
          ...
          <div className="flex flex-col gap-12">
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  You gain expertise in programming, AI and deep learning, cloud computing, database management, and other cutting-edge IT domains - equipping you for modern tech roles.
                </p>
              </div>
            </motion.div>
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                  The program is fully online, with live and recorded classes, virtual labs, e-libraries, and remote-proctored exams - so you can upskill without leaving your current job or disrupting your schedule.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col gap-12">
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                 The MCA is UGC-entitled, from a NAAC A+ accredited university - giving you a degree that’s equivalent to regular campus qualifications and widely accepted for jobs or further studies.
                </p>
              </div>
            </motion.div>
           ...
           "
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-md">
                 On completion, you’ll be qualified for a range of IT careers - software development, data science, cloud computing, cybersecurity, database administration, systems analysis, and more - enhancing your employability and growth potential.
                </p>
              </div>
            </motion.div>
          </div>
