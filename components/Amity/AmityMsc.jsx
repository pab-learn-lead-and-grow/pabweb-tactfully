...
export default function Page() {
  ...
  const subjects = [{ id: 1, name: "M.Sc Data Science" }];
    ...
    <main className="flex flex-col items-center w-full bg-white">
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
            Accelerate your professional growth with a UGC-approved Online M.Sc. Master machine learning, big data, and statistics to solve real-world business problems. </motion.p>
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <div className="mb-5">
            ...
            <ul className="text-[#1F284E] text-[32px] px-5 list-disc mb-5 space-y-4 leading-tight">
              <li>
              Bachelor's degree in any Science discipline.</li>
            </ul>
          </div>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Amity University Online M.Sc follows a structured and
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
            ...
            <h2 className="text-[#345895] text-[46px] md:text-[52px] lg:text-[62px] font-bold leading-[1.05] max-w-[720px]">
              ...
              <span className="block">Online M.Sc</span>
              <span className="block">Certificate</span>
            </h2>

            <p className="text-[#3C3C43] max-w-[530px] text-base leading-relaxed">
            Amity Online's 2 year M.Sc program provides a strong foundation in analytical, and data engineering skills</p>
