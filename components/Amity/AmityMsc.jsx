...
`}
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full h-[250px] overflow-y-auto no-scrollbar xl:w-[90%]">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-4 w-full bg-[#4D964F] text-white px-4 py-4 rounded-2xl bg-linear-to-r from-[#4D964F] to-[#193019] shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Amity University Online M.Sc follows a structured and transparent
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-16">
        ...
        <div className="w-full overflow-hidden">
          {/* HEADER ROW */}
          <div className=" max-w-5xl flex items-center justify-center  bg-[#E5E5E5] text-[#4D964F] font-semibold text-center m-auto px-10 lg:px-30 py-8 text-[16px] md:text-[24px] rounded-xl">
