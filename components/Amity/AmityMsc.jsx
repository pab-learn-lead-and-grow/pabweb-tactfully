...
export default function Page() {
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <p className="text-[#C4C4C4] font-bold text-[22px] mt-3">M.Sc</p>
  ...
  const subjects = [{ id: 1, name: "Data Science" }];
...
"Professional Ethics",
  ...
  const [isModalOpen, setIsModalOpen] = useState(false);
    ...
    const faqs = [
    {
      q: "What is the duration and delivery mode of the Online M.Sc Data Science?",
      a: "The program runs for 2 years (4 semesters) and is delivered entirely online through Amity’s digital learning platform (live + recorded lectures, study materials, remote assessments).",
    },
    {
      q: "Who is eligible to apply for this program?",
      a: "Applicants must hold a bachelor’s degree (in a relevant discipline) from a recognised university.",
    },
    {
      q: "What does the curriculum of the M.Sc in Data Science cover?",
      a: "The curriculum includes core areas such as statistics, machine learning, big data analytics, data engineering, data visualization, deep learning, database technologies, and other advanced topics — combining theory with practical, real-world data projects.",
    },
    {
      q: "Is this online degree recognized and valid for employment or further studies?",
      a: "Yes - the program is UGC-entitled through Amity Online and carries academic recognition comparable to on-campus M.Sc degrees, making it valid for employment and further academic pursuits.",
    },
    {
      q: "Can working professionals or those with other commitments enrol?",
      a: "Absolutely. The flexible online format — with recorded lectures, 24/7 access to materials, and remote examination — allows learners to study without interrupting work or personal commitments. ",
    },
  ];
  ...
  return (
      ...
      <section className="relative min-h-[50vh] w-full ">
              ...
              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                ...
                <div className="flex flex-col items-start">
                  ...
                  >
                    Accelerate your professional growth with a UGC-approved Online M.Sc. Master machine learning, big data, and statistics to solve real-world business problems.
                  </motion.p>
      ...
      <WhyChooseUs title="Why Choose AMITY Online MSc." cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
                    ...
                    (topic, index) => (
                      ...
                      >
                        <motion.div
                          ...
                          className="w-5 h-5 sm:w-6 sm:h-6 shrink-0flex items-center justify-center rounded-full bg-white group-hover:bg-[#270652] transition"
                        >
                          <Check
                            size={12}
                            className="sm:size-6 text-[#270652] group-hover:text-white transition"
                          />
                        </motion.div>
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full h-[250px] overflow-y-auto no-scrollbar xl:w-[90%]">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-4 w-full bg-[#F6A410] text-white px-4 py-4 rounded-2xl shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for AMITY Online MSc.
          </h2>
          ...
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] list-disc px-5 space-y-2 md:space-y-4 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              <li>Bachelor's degree in any Science discipline.
                </li>  
            </ul>
          </div>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
                                          ...
                                          <div className="max-w-6xl mx-auto relative">
                                            ...
                                            >
                                              The Amity University Online MSc follows a structured and
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online MSc.
              </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-[#270652] text-[32px] md:text-[40px] lg:text-[64px] font-bold leading-tight">
              Amity University
              <br />
              Online M.Sc Certificate
            </h2>

            <p className="text-[#3C3C43] max-w-[350px] text-base">
            Amity Online's 2 year M.Sc program provides a strong foundation in analytical, and data engineering skills
            </p>

            {/* IMAGE that appears ONLY on mobile, above CTA */}
            <div className="md:hidden flex justify-center">
              <img
                src="/amity/degree/amityMscDegree.png"
