        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            <motion.h1
              ...
              viewport={{ once: true }}
              className="text-white text-4xl sm:text-5xl md:text-5xl lg:text-[56px] xl:text-[64px] font-[Inter] font-bold -mt-1 leading-tight"
            >
      ...
      <section className="w-full flex items-center justify-center px-6 md:px-18">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-20">
          ...
          <div className="space-y-5">
            ...
            <button 
              onClick={() => setIsModalOpen(true)}
              className="bg-[#F6A410] text-white font-medium text-sm px-10 py-2 rounded-lg shadow-md transform hover:scale-105 duration-200 flex items-center justify-center">
              Know more
            </button>
          </div>
