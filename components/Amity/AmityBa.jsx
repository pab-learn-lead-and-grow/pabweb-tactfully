...
export default function Page() {
  ...
  {stats.map((stat, idx) => (
    ...
    >
      ...
      <WhyChooseUs title="Why Choose AMITY Online BA" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
      ...
      <section className="w-full bg-white px-4 md:px-16 py-10 lg:py-20">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-20 lg:gap-30 w-full xl:hidden">
            ...
            <div className="col-span-1">
              <div className="flex flex-col items-center">
                <div className="flex flex-col gap-2 sm:gap-3 h-[110px] md:h-[130px] overflow-y-auto no-scrollbar w-full mt-4">
                  {semesters.map((sem) => (
                    <motion.button
                      key={sem}
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-center">
            <div className="max-h-[400px] w-[90%]">
              <div className="flex flex-col w-full overflow-y-auto no-scrollbar gap-4 mt-12 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    key={sub.id}
                    onClick={() => {
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              onClick={() => setIsModalOpen(true)}
              className="mt-8 w-[90%] bg-[#F6A104] text-white px-4 py-4 rounded-2xl shadow-lg flex items-center justify-center gap-4"
            >
              DOWNLOAD SYLLABUS
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online BA
              </h2>
