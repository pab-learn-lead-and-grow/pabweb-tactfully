...
<CounsellingModal>
  ...
  >
    ...
    <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
      ...
      <WhyChooseUs title="Why Choose AMITY Online BA" cards={whyCards} />

        <SyllabusSection
  title="AMITY Online BA Syllabus"
  subjects={subjects}
  semesters={semesters}
  semSuffix={semSuffix}
...
/>
      ...
      <section className="w-full font-sans px-4 md:px-10 lg:px-20 lg:py-12">
      ...
      <section className="w-full flex items-center justify-center pt-10 px-4 md:px-18">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 justify-center font-sans lg:gap-10">
          {/* LEFT CONTENT */}
