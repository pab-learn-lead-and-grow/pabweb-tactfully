     ...
     <section className="relative min-h-[50vh] w-full ">
             ...
             <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
               ...
               <div className="flex flex-col items-start">
                 ...
                 >
                   AMITY Online BAJMC : Fees, Eligibility & Admission Dates 2026
                 </MotionWrapper>
  ...
  >
    ...
    <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
     ...
     <section className="w-full bg-white py-10 px-4 lg:px-10 pt-0">
      ...
      <WhyChooseUs title="Why Choose AMITY Online BAJMC" cards={whyCards} />

      <SyllabusSection
  title="AMITY Online BAJMC Syllabus"
  subjects={subjects}
  semesters={semesters}
  semSuffix={semSuffix}
...
/>
      ...
      <section className="w-full font-sans px-4 md:px-10 lg:px-10 py-6">
