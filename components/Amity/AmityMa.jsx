...
export default function Page() {
  ...
  const subjects = [{ id: 1, name: "Public policy & Governance" }];
 ...
 const topicsData = {
    1: {
      1: [
        "Public Administration: Concept & Theory",
...
"Dynamics of State Administration",
"Law and Public Policy",
"Public Personnel Administration",
"Public Policy-Concepts and Models",
"Seminar",
],
      3: [
...
"Leadership and Administrative Thinkers (Elective course)",
"Economics and Public Policy (Elective Course)",
"Urban and Rural Development in India (Elective Course)",
"Internship (PG)",
"Professional Ethics",
...
"Dissertation",
   ...
   const faqs = [
    {
      q: "What is the duration and format of the MA Public Policy program?",
      a: "The program spans 2 years (4 semesters) and is delivered entirely online through Amity’s digital learning platform, with live and recorded lectures, digital resources, and remote assessments.",
    },
    {
      q: "Who is eligible to apply for the MA in Public Policy?",
      a: "Applicants must hold a bachelor's degree (10+2+3 or equivalent) from a recognised university.",
    },
    {
      q: " Does the program allow working professionals to study while employed?",
      a: "Yes - its fully online, flexible format is designed to accommodate working individuals or others with time constraints.",
    },
    {
      q: "What kind of subjects and learning does the curriculum cover?",
      a: "The curriculum covers governance, public policy theory, policy analysis, socio-economic studies, and contemporary public issues, equipping learners with analytical and strategic skills for public policy work.",
    },
    {
      q: " How are classes, resources, and assessments delivered online?",
      a: "Students get access to live and recorded lectures, digital study materials, discussion forums, assignments, and online examinations - all through Amity's online learning management system.",
    },
  ];
      ...
      <main className="flex flex-col items-center w-full bg-white">
       <section className="relative min-h-[50vh] w-full ">
              ...
              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                ...
                >
                 Master of Arts (MA) in Public Policy & Governance
                </MotionWrapper>
                ...
                <div className="flex flex-col items-start">
                  ...
                  as="h1"
                    ...
                    viewport={{ once: true }}
                    className="text-white text-[20px] md:text-4xl lg:text-5xl xl:text-[64px] font-sans font-bold mt-1 leading-tight"
                  >
                    AMITY Online MA : Fees, Eligibility & Admission Dates 2026
                  </MotionWrapper>
                  ...
                  >
                    Advance your leadership and policy skills with a UGC-recognized Online MA in Public Policy & Governance. Learn to analyze social challenges, design impactful policies, and contribute to global change under the guidance of renowned international faculty.
                  </MotionWrapper>
  ...
  >
    ...
    <section className="w-full bg-white py-10 px-4 lg:px-10 pt-0">
     ...
     {/* ======= SNAPSHOT SECTION ======= */}
      ...
      <section className="w-full bg-white p-10 py-12 flex flex-col lg:mb-20 gap-12">
        ...
        <div className="max-w-6xl text-left mx-auto">
          <h2 className="text-xl md:text-2xl font-regular lg:text-[36px] leading-normal text-gray-900">
            ...
            Advance your leadership and policy expertise through a UGC-recognized Online MA in Public Policy and Governance.{" "}
            </span>
           Master the art of analyzing societal issues, shaping impactful policies, and contributing to global problem-solving, guided by acclaimed international faculty. Become an asset to government, non-profits, corporates, and global organizations.</h2>
        </div>
      ...
      <WhyChooseUs title="Why Choose AMITY Online MA" cards={whyCards}  />

     <SyllabusSection
  title="AMITY Online MA Syllabus"
  subjects={subjects}
  semesters={semesters}
  semSuffix={semSuffix}
      ...
      <section className="w-full font-sans px-4 md:px-10 lg:px-20">
        <div className="p-10 md:p-20">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility  for AMITY Online MA
          </h2>
          <ul className="text-black text-[12px] space-y-2 md:space-y-4 list-disc px-5 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
            <li>
              Any of the degrees mentioned for the Indian students. (Any BA Degree)
              </li>
            <li>
             Well versed in spoken as well as written English</li>
             <li>
            Certificate of equivalence from the Association of Indian Universities (required by any student with foreign education to apply to any University in India, refer to https://aiu.ac.in/)</li>
          </ul>
          {/* for Indian Students */}
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] list-disc px-5 space-y-2 md:space-y-4 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              <li>Graduation Degree (3 years or 4 years Degree program, Diploma will not be acceptable)</li>  
            </ul>
          </div>
      ...
      />
       ...
       <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-sans relative">
                                          ...
                                          <div className="max-w-6xl mx-auto relative">
                                            ...
                                            >
                                              The Amity University Online MA follows a structured and
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online MA
              </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-sans lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-[#270652] text-[32px] md:text-[40px] lg:text-[64px] font-bold leading-tight">
              Amity University
              <br />
              Online MA Public Policy & Governance Certificate
            </h2>

            <p className="text-[#3C3C43] max-w-[350px] text-base">
            This program equips you with the skills to solve complex real-world issues and build cutting-edge policies.
            </p>

            {/* IMAGE that appears ONLY on mobile, above CTA */}
            <div className="md:hidden flex justify-center">
              <Image
                src="/amity/degree/amityMappgDegree.png"
 ...
 <CounsellingModal>
  ...
  >
    Know more
      ...
      <section className="w-full bg-white mt-20 px-4 md:px-12 lg:px-20 py-16 font-sans">
        {/* Small Header */}
        <MotionWrapper
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              >
                {[
                  ...
                  "News Editor",
                  "Program Manager / Development Officer (NGOs & Social Impact Organizations)",
                ].map((role, index) => (
                  <MotionWrapper
                    key={index}
                  ...
                  >
                    <span className="w-7 h-7 rounded-full bg-[#F6A104] flex items-center shrink-0 justify-center">
