...
"Dissertation",
  ...
  return (
     ...
     {/* ======= SNAPSHOT SECTION ======= */}
      ...
      <WhyChooseUs title="Why Choose AMITY Online MA" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
        ...
        >
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-center">
            <div className="max-h-[400px] w-[90%]">
              <div className="flex flex-col w-full h-[150px] overflow-y-auto no-scrollbar gap-4 mt-40 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    key={sub.id}
                    onClick={() => {
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full xl:w-[90%]">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-2 w-full bg-[#F6A104] text-white px-4 py-4 rounded-2xl  shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
