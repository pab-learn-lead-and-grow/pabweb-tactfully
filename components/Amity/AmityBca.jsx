...
export default function Page() {
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div>
                ...
                <p className="text-[#C4C4C4] font-bold text-[22px] mt-3">BCA</p>
  ...
  const subjects = [
    ...
    { id: 2, name: "Cloud & Security" },
    { id: 3, name: "Software Engineering" },
    { id: 4, name: "Data Engineering" },
    { id: 5, name: "Financial Technology & AI" },
  ];
  ...
  const topicsData = {
    1: {
      ...
      5: [
        ...
        "Professional Ethics",
        "Data Anlytics & Reporting",
        "Data Modelling & Visulization",
      ],
      6: [
    ...
    5: {
      ...
      4: [
        "Unix Operating System and Shell Programming",
        "Python Programming",
        "Foundations of FinTech, Data Analytics & Financial Markets",
        "Programming for FinTech (Python, R, and Java) + Data Analytics",
        "Foundations of AI and Blockchain Development",
      ],
      5: [
        "Fundamentals of Ecommerce",
        "Introduction to Artificial Intelligence",
        "Professional Ethics",
        "AI Cybersecurity and API Innovation in FinTech",
        "Cloud Computing Big Data and InsurTech in FinTech",
      ],
      6: [
        "Major Project",
        "RegTech Compliance and FinTech Application Development",
        "FinTech Trends, Compliance & Product Conceptualization",
        "FinTech Product Development & Prototype Presentation",
      ],
    },
  };
  ...
  const faqs = [
    {
      q: "What is the duration and structure of the Online BCA?",
      a: "The program spans 3 years (typically divided into 6 semesters). It is delivered fully online through Amity’s learning platform with live and recorded lectures, digital resources, assignments, and online evaluations.",
    },
    {
      q: "What are the eligibility criteria for admission?",
      a: "Applicants must have completed 10+2 (or equivalent) from a recognised board or institution, with necessary minimum marks as specified by the university.",
    },
    {
      q: " Is prior work experience or technical background required to enroll?",
      a: "No. The course is open to fresh 10+2 students. Prior work experience or advanced technical background is not mandatory.",
    },
    {
      q: " How flexible is the program for working students or those with other commitments?",
      a: "The fully online delivery model, along with recorded lectures and flexible schedules, makes it ideal for working professionals and students managing multiple commitments.",
    },
    {
      q: "What does the curriculum cover - which skills and topics will I learn?",
      a: "The curriculum includes computer science fundamentals, software development, database management, programming languages, web development, and other key aspects of computing.",
    },
  ];
  ...
  return (
    <main className="flex flex-col items-center w-full bg-white">
        ...
        <div className="max-w-6xl text-left mx-auto">
          <h2 className="text-xl md:text-2xl font-regular lg:text-[36px] leading-normal text-gray-900">
            <span className="text-[#F9BD04] ">
              Launch your journey in IT with a UGC-entitled Online BCA.{" "}
            </span>
            This 3-year program builds your foundation in software development
            and computer applications, opening doors to careers as a software
            engineer, system analyst, web designer, and more. Complete
            real-world projects, access personalized mentoring, and earn your
            degree with full online flexibility.
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            <div>
              ...
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
                Immerse yourself in a world-class learning environment taught by
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            <div>
              ...
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
                 Gain industry-ready expertise through specializations created
                with TCS iON
              </p>
            </div>
          </div>
      ...
      <WhyChooseUs title="Why Choose AMITY Online BCA" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
      ...
      <section className="w-full bg-white px-4 md:px-16 py-10 lg:py-20">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-20 lg:gap-30 w-full xl:hidden">
            ...
            <div className="col-span-1">
              <div className="flex flex-col items-center">
                <div className="w-full">
                  <div className="flex flex-col w-full h-[250px] overflow-y-auto no-scrollbar gap-2 sm:gap-3 mt-4 items-center">
                    {subjects.map((sub) => (
                      <motion.button
                        key={sub.id}
                        onClick={() => {
            ...
            <div className="col-span-1">
              <div className="flex flex-col items-center">
                <div className="flex flex-col gap-2 sm:gap-3 w-full h-[150px] md:h-[180px] overflow-y-auto no-scrollbar mt-4">
                  {semesters.map((sem) => (
                    <motion.button
                      key={sem}
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-center">
            <div className="max-h-[400px] w-[90%]">
              <div className="flex flex-col w-full h-[250px] overflow-y-auto no-scrollbar gap-4 mt-10 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    key={sub.id}
                    onClick={() => {
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full h-[180px] overflow-y-auto no-scrollbar xl:w-[90%]">
              {semesters.map((sem) => (
                <motion.button
                  key={sem}
                  onClick={() => setActiveSemester(sem)}
            ...
            <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-8 w-[90%] bg-[#F6A104] text-white px-2 py-3 rounded-2xl shadow-lg flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-6">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for AMITY Online BCA
          </h2>
          <ul className="text-black text-[12px] space-y-2 md:space-y-4 list-disc px-5 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
            <li>
              Fresh 10+2 pass out students or aspirants seeking a career in
              Computer Applications (Online BCA Course).
            </li>
            <li>
            ...
            <li>
              Candidates who have not studied in English for at least three (3)
              years in their academic qualifications are not eligible.
            </li>
            <li>
              Appropriate for aspirants who want to explore career opportunities
              in private/public sector organizations in industries including IT
              & ITES, Financial Services, and more, as Computer Programmer,
              Information Security Analyst, Network and Test Engineer, Database
              Administrator, Quality Assurance Engineer,
              Customer/Helpdesk/Technical Support Engineer, among others.
            </li>
            <li>
              Learners who want to build the academic foundation to pursue
              higher education in the subject or professional courses to excel
          ...
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] list-disc px-5 space-y-2 md:space-y-4 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              <li>
                Secondary school certificate (Completing 10 years of formal
                schooling. Diploma will not be acceptable).
              </li>
              <li>
                Senior secondary school certificate (Completing 12 years of
                formal schooling. Diploma will not be acceptable).
              </li>
              <li>
     ...
     <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
                                         ...
                                         <div className="max-w-6xl mx-auto relative">
                                           ...
                                           >
                                             The Amity University Online BCA follows a structured and
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online BCA
              </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-[#270652] text-[32px] md:text-[40px] lg:text-[64px] font-bold leading-tight">
              Amity University
              <br />
              Online BCA Certificate
            </h2>

            <p className="text-[#3C3C43] max-w-[350px] text-base">
              Bachelor of Computer Applications (Online BCA Course) is a 3 year
              program covering software testing, web design, development,
              programming, networking, and computer systems.
            </p>

            {/* IMAGE that appears ONLY on mobile, above CTA */}
            <div className="md:hidden flex justify-center">
              <img
                src="/amity/degree/amityBcaDegree.png"
