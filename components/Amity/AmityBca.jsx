      ...
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
          Begin your IT journey with a UGC-approved Online BCA. Develop core technical skills, work on real projects, and prepare for careers in software development, systems analysis, and web design through flexible online learning. </motion.p>
            {/* STATS */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-7xl text-left mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal text-[40px] leading-snug text-gray-900">
            ...
            This 3-year program builds your foundation in software development and computer applications, opening doors to careers as a software engineer, system analyst, web designer, and more. Complete real-world projects, access personalized mentoring, and earn your degree with full online flexibility. </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              Immerse yourself in a world-class learning environment taught by leading international experts. </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            {/* Content */}
            <div>
              <h3 className="text-lg text-[#064E92] mb-1">Industry Collaborations</h3>
              <p className="text-gray-700 text-sm leading-relaxed">
                Gain industry-ready expertise through specializations created with TCS iON
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <ul className="text-[#1F284E] text-[32px] px-5 list-disc mb-5 space-y-4 leading-tight">
            <li>
            Fresh 10+2 pass out students or aspirants seeking a career in Computer Applications (Online BCA Course).
            </li>
             <li>
          ...
          Candidates who have not studied in English for at least three (3) years in their academic qualifications are not eligible
           ...
           Appropriate for aspirants who want to explore career opportunities in private/public sector organizations in industries including IT & ITES, Financial Services, and more, as Computer Programmer, Information Security Analyst, Network and Test Engineer, Database Administrator, Quality Assurance Engineer, Customer/Helpdesk/Technical Support Engineer, among others.
            ...
            <li>Learners who want to build the academic foundation to pursue higher education in the subject or professional courses to excel in the Technology domain.</li>
          </ul>
          {/* for Indian Students */}
          <div className="mb-5">
          ...
          <div className="mb-5">
            ...
            <ul className="text-[#1F284E] text-[32px] mb-5 space-y-4 list-disc px-5 leading-tight">
              <li>
               ...
               <li>
             Senior secondary school certificate (Completing 12 years of formal schooling. Diploma will not be acceptable).</li>
              <li>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
            ...
            <h2 className="text-[#345895] text-[46px] md:text-[52px] lg:text-[62px] font-bold leading-[1.05] max-w-[720px]">
              ...
              <span className="block">Online BCA</span>
              <span className="block">Certificate</span>
            </h2>

            <p className="text-[#3C3C43] max-w-[530px] text-base leading-relaxed">
           Bachelor of Computer Applications (Online BCA Course) is a 3 year program covering software testing, web design, development, programming, networking, and computer systems.
           </p>
