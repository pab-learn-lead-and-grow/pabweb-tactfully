      ...
      <section className="relative min-h-[50vh] w-full ">
                     ...
                     <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                       ...
                       <div className="flex flex-col items-start">
                         ...
                         >
                          AMITY Online MCA : Fees, Eligibility & Admission Dates 2026
                         </MotionWrapper>
                         ...
                         >
                          A high-impact blend of academic depth, AI-powered tools, and practical projects that equip you for real-world industry challenges.<br />Experience personalized learning, 24/7 mentorship, and advanced simulations built to help you succeed in a digital-first business landscape.
                                         ...
                                         <MotionWrapper
                                           ...
                                           transition={{ duration: 0.7 }}
                                           viewport={{ once: true }}
                                           className="grid grid-cols-2 mt-5 md:grid-cols-2 lg:grid-cols-4 lg:-mx-10 xl:-mx-15 gap-y-5 font-sans w-full"
                                         >
                                           {stats.map((stat, idx) => (
                                             <div
                                               key={idx}
...
<CounsellingModal>
 ...
 <section className="w-full bg-white py-10 px-4 lg:px-10 pt-0">
      ...
      <WhyChooseUs title="Why Choose AMITY Online MCA" cards={whyCards}  />

      <SyllabusSection
  title="AMITY Online MCA Syllabus"
  subjects={subjects}
  semesters={semesters}
  semSuffix={semSuffix}
...
/>
      ...
      <section className="w-full font-sans px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for AMITY Online MCA
          </h2>
          <ul className="text-black text-[12px] space-y-2 md:space-y-4 list-disc px-5 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
            ...
            <li>
              Working professionals seeking higher education in computer
              technology and those wishing to further their knowledge to solve
              complex real world issues and build cutting edge products.
            </li>
            <li>
              Aspirants willing to explore career opportunities in
              private/public sector organizations in industries including IT &
              ITES, Financial Services, and more as Computer programmer,
              Information Security Analyst, Network and test Engineer, Database
              Administrator, Quality Assurance Engineer, Full Stack Developer,
              among others.
            </li>
          </ul>
          {/* for Indian Students */}
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] list-disc px-5 space-y-2 md:space-y-4 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              ...
              <li>
                Bachelor's Degree in Science / Commerce / Arts with Mathematics
                at 10+2 level
              </li>
              <li>
                Students without Mathematics at 10+2 or graduation can also
                apply after qualifying the bridge course
              </li>
            </ul>
          </div>
          ...
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] list-disc px-5 space-y-2 md:space-y-4 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              <li>
                Bachelor’s Degree or any of the degrees mentioned for the Indian
                students. (BCA is preferable)
              </li>
              <li>Well versed in spoken as well as written English</li>
              <li>
      ...
      />
       ...
       <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-sans relative">
                                         ...
                                         <div className="max-w-6xl mx-auto relative">
                                           ...
                                           >
                                             The Amity University Online MCA follows a structured and
      ...
      <section className="w-full font-sans py-20 flex items-center justify-center">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online MCA
              </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-sans lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <div className="md:hidden flex justify-center">
              <Image
                src="/amity/degree/amityMcaDegree.png"
  ...
  >
    Know more
      ...
      <section className="w-full bg-white px-4 pt-10 md:px-12 lg:px-20 font-sans">
        {/* Small Header */}
        <MotionWrapper
