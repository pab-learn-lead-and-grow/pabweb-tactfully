      ...
      <section className="relative min-h-screen lg:min-h-[50vh] xl:min-h-screen w-full ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <motion.span
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="inline-block bg-[#EEA727] text-white text-[18px] sm:text-[18px] mt-6  mb-2 font-sm px-5 py-1 rounded-full"
          >
            Best Seller
          </motion.span>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-white text-[16px] italic font-light"
          >
            PG Program
          </motion.p>
          ...
          <div className="flex flex-col items-start">
            <motion.h1
              ...
              viewport={{ once: true }}
              className="text-white text-4xl sm:text-5xl md:text-5xl xl:text-[60px] lg:text-[54px] font-[Inter] font-bold -mt-1 leading-tight"
            >
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
              viewport={{ once: true }}
              className="grid grid-cols-2 lg:grid-cols-4 mt-5 lg:-mx-10 gap-y-4 font-[Inter] w-full"
            >
              {stats.map((stat, idx) => (
                <div
                  key={idx}
                ...
                <div className="flex flex-col gap-2 sm:gap-3 w-full mt-4">
                  ...
                  <motion.button
                    ...
                    className="
                                 ...
                                 shadow-md
                                 flex items-center justify-center md:mt-4 gap-2
                               "
                  >
                    DOWNLOAD SYLLABUS
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full xl:w-[90%]">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-6 w-full bg-[#F6A104] text-white px-5 py-3 rounded-2xl shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
