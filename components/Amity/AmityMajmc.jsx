...
export default function Page() {
  ...
  const faqs = [
    ...
    {
      q: "What are the eligibility criteria to apply for Online MAJMC?",
      a: "You need to hold a bachelor's degree (10+2+3 or equivalent) from a recognized university to qualify.",
    },
    {
      q: "What kind of courses and skills does the curriculum cover?",
      a: "The MAJMC covers core and modern media subjects - including mass communication theory, print and digital reporting, media laws/ethics, media design and visualization, photography, and multimedia production, preparing you for various media roles.",
    },
    {
      q: "How is learning delivered - live lectures, assignments, exams, etc.?",
      a: "The program uses a fully online learning management system: students access live and recorded lectures, digital study materials, discussion forums, and complete assignments and exams online.",
    },
    {
      q: "Is the online MAJMC degree recognized and valid for employment or further studies?",
      a: "Yes. Amity University Online is UGC recognized for its online degrees, making MAJMC valid and acceptable to employers and academic institutions.",
    },
  ];
  ...
  return (
    <main className="flex flex-col items-center w-full bg-white">
      ...
      <WhyChooseUs title="Why Choose AMITY Online MAJMC" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
        ...
        >
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-center">
            <div className="max-h-[400px] w-[90%]">
              <div className="flex flex-col w-full h-[350px] overflow-y-auto no-scrollbar gap-4 mt-40 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    key={sub.id}
                    onClick={() => {
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full xl:w-[90%]">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-2 w-full text-white px-2 py-3 rounded-2xl bg-[#F6A104] shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for AMITY Online MAJMC
          </h2>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online MAJMC
              </h2>
  ...
  >
    Know more
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 pb-10">
        {/* TITLE */}
