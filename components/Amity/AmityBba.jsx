...
"World Tourism Destination",
 ...
 const faqs = [
  ...
  return (
      ...
      <section className="relative min-h-[50vh] w-full ">
              ...
              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                ...
                <div className="flex flex-col items-start">
                  ...
                  >
                    Build strong business and leadership skills with a UGC-approved Online BBA - 3 years, 6 semesters, and flexible learning from top faculty.
                  </motion.p>
      ...
      <WhyChooseUs title="Why Choose AMITY Online BBA" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-6">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for AMITY Online BBA
          </h2>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online BBA
              </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-[#270652] text-[32px] md:text-[40px] lg:text-[64px] font-bold leading-tight">
              Amity University
              <br />
              Online BBA Certificate
            </h2>

            <p className="text-[#3C3C43] max-w-[350px] text-base">
            Bachelor of Business Administration (BBA Degree) is a comprehensive 3 years (6 semesters) UG program offering in-depth study of theoretical concepts and functional areas in Business Administration.
            </p>

            {/* IMAGE that appears ONLY on mobile, above CTA */}
            <div className="md:hidden flex justify-center">
              <img
                src="/amity/degree/amityBbaDegree.png"
