...
export default function Page() {
  ...
  const faqs = [
    {
      q: "What is the duration and structure of the Online BBA?",
      a: "The program lasts 3 years, typically organized into 6 semesters. It’s delivered fully online through Amity’s digital learning platform (live classes, recorded lectures, digital resources).",
    },
    {
      q: "Who is eligible to apply for the Online BBA program?",
      a: "You need to have completed 10+2 (or equivalent) from a recognized board or institution to be eligible for admission.",
    },
    {
      q: " Is prior work experience required to enroll?",
      a: "No — the course is open to fresh students who meet the 10+2 eligibility criteria. Work experience is not necessary.",
    },
    {
      q: "What is the fee structure and are there flexible payment options?",
      a: "Fees vary depending on specialization and institution policy. Amity often provides semester-wise payment options or EMIs to help with affordability.",
    },
    {
      q: "What specialized programs or electives are available in this BBA?",
      a: "The Online BBA offers a variety of specializations in fields like management, finance, business analytics, digital business, etc., allowing you to tailor the degree to your interests and career goals.",
    },
  ];
  ...
  const subjects = [
    ...
    { id: 2, name: "Travel & Tourism Management" },
    ...
    <main className="flex flex-col items-center w-full bg-white">
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
           Build strong business and leadership skills with a UGC-approved Online BBA—3 years, 6 semesters, and flexible learning from top faculty.</motion.p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
              viewport={{ once: true }}
              className="grid grid-cols-2 mt-5 md:grid-cols-4 gap-y-6 w-7xl"
            >
              {stats.map((stat, idx) => (
                <div
                  key={idx}
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-7xl text-left mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal text-[40px] leading-snug text-gray-900">
            ...
            Unlock your leadership potential with a UGC-entitled Online BBA. {" "}
            </span>
          Over 3 years and 6 semesters, you’ll master essential business concepts, strengthen your managerial abilities, and learn from top faculty, all through a flexible online format that fits your lifestyle. </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
               Forward-looking specializations crafted to lead the business landscape of tomorrow.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            {/* Content */}
            <div>
              <h3 className="text-lg text-[#064E92] mb-1">Personalised Learning</h3>
              <p className="text-gray-700 text-sm leading-relaxed">
                Tailor your academic journey with a unique choice-based credit system designed for personalized learning.
          ...
          <div className="mb-5">
            ...
            <ul className="text-[#1F284E] text-[32px] mb-5 space-y-4 list-disc px-5 leading-tight">
              <li>
               ...
               <li>
             A Level Certificate (Completing 12 years of formal schooling. Diploma not accepted).</li>
              <li>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Amity University Online BBA follows a structured and
      ...
      <section className="w-full mt-20">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
           ...
           Bachelor of Business Administration (BBA Degree) is a comprehensive 3 years (6 semesters) UG program offering in-depth study of theoretical concepts and functional areas in Business Administration.</p><button className="bg-[#4D964F] text-white font-medium text-sm px-10 py-2 rounded-lg bg-linear-to-r from-[#4D964F] to-[#193019] border-0 shadow-md shadow-[#1C361D] transform hover:scale-105 duration-200 flex items-center justify-center">
              Know more
            </button>
          </div>
