      ...
      <section className="relative min-h-[50vh] w-full ">
              ...
              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                ...
                <div className="flex flex-col items-start">
                  ...
                  >
                  AMITY Online MCOM : Fees, Eligibility & Admission Dates 2026
                  </MotionWrapper>
...
<CounsellingModal>
  ...
  >
    ...
    <section className="w-full bg-white py-10 px-4 lg:px-10 pt-0">
      ...
      <WhyChooseUs title="Why Choose AMITY Online MCOM" cards={whyCards} />

         <SyllabusSection
  title="AMITY Online MCOM Syllabus"
  subjects={subjects}
  semesters={semesters}
  semSuffix={semSuffix}
...
/>
      ...
      <section className="w-full font-sans px-4 md:px-10 lg:px-20 py-12">
...
<CounsellingModal>
  ...
  >
    Know more
      ...
      <section className="w-full bg-white lg:mt-20 px-4 md:px-12 lg:px-20 pt-16 font-sans">
        {/* Small Header */}
        <MotionWrapper
