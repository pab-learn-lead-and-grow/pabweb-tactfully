...
export default function Page() {
  ...
  const faqs = [
    {
      q: "What is the duration and format of the Online M.Com (FinTech)?",
      a: "The program runs for 2 years (4 semesters) and is delivered entirely online through a digital learning platform.",
    },
    {
      q: "What are the eligibility requirements for admission?",
      a: "You need a bachelor's degree from a recognised university (10+2+3 or equivalent). Work experience is not mandatory.",
    },
    {
      q: "What will I learn in this FinTech specialization?",
      a: "The curriculum covers modern finance + technology topics: digital banking, blockchain, financial data analysis, financial engineering, risk & portfolio management, and fintech regulation.",
    },
    {
      q: "How are courses delivered and assessed online?",
      a: "Students receive live and recorded lectures, access e-learning resources and e-libraries, and complete assignments, projects, and exams online (web-proctored or remote format).",
    },
    {
      q: "Is the degree recognised and valid for jobs or further studies?",
      a: "Yes - the online M.Com in FinTech is offered by Amity Online, which is recognised and its degrees are widely accepted by employers and academic institutions.",
    },
  ];
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <p className="text-[#C4C4C4] font-bold text-[22px] mt-3">M.COM</p>
  ...
  const subjects = [
    { id: 1, name: "Finacial Management" },
    { id: 2, name: "Financial Technology" },
  ];
...
"Data-Driven Decision Making and Generating Insights",
"Digital Currency",
"Financial Reporting and Decision Making",
...
"Treasury Management",
  ...
  return (
      ...
      <section className="relative min-h-[50vh] w-full ">
              ...
              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                ...
                <div className="flex flex-col items-start">
                  ...
                  >
                    Boost your global career with India’s first UGC-approved Online M.Com. Gain expertise in finance, marketing, and accounting with guidance from international faculty.
                  </motion.p>
        ...
        <div className="max-w-6xl text-left mx-auto">
          <h2 className="text-xl md:text-2xl font-regular lg:text-[36px] leading-normal text-gray-900">
            <span className="text-[#F9BD04] ">
             Advance your career globally with India’s first UGC-entitled Online M.Com.{" "}
            </span>
            Build expertise in finance, marketing, and accounting, study with international faculty, and develop strong analytical and leadership skills for top roles.
            </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            <div>
              ...
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
                 Receive a truly global learning experience guided by distinguished international faculty.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            <div>
              ...
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
               Advanced specializations designed to shape the future of the financial industry.
              </p>
            </div>
          </div>
        </div>
      ...
      <WhyChooseUs title="Why Choose AMITY Online MCOM" cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />
        ...
        >
                ...
                <div className="flex flex-col gap-2 sm:gap-3 w-full mt-4">
                  ...
                  <motion.button
                    ...
                    className="
                                 ...
                                 shadow-md
                                 flex items-center justify-center mt-2 gap-2
                               "
                  >
                    DOWNLOAD SYLLABUS
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-center">
            <div className="max-h-[400px] w-[90%]">
              <div className="flex flex-col w-full h-[350px] overflow-y-auto no-scrollbar gap-4 mt-35 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    key={sub.id}
                    onClick={() => {
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full xl:w-[90%]">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-2 w-full bg-[#F6A104] text-white px-2 py-3 rounded-2xl shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for AMITY Online MCOM
          </h2>
          <ul className="text-black text-[12px] space-y-2 md:space-y-4 list-disc px-5 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
            <li>
              Fresh graduates or final year Students seeking a career in the
              finance domain.
            </li>
            <li>
              Graduation Degree (3 years or 4 years degree program only, Diploma will not be acceptable)
            </li>
            <li>
              Entrepreneurs who want to improve their financial management skills and update their knowledge of statistics, law and other financial aspects.
            </li>
            <li>
             Professionals who want to explore career opportunities in private/public sector organizations and government departments in industries including Financial Services, Insurance, Infrastructure, Banking and many more as Finance Manager, Banking Officer, Financial/ Insurance Advisor, and Finance Controller, among others.
             </li>
            <li>
          ...
          <div className="mb-5">
            ...
            <ul className="text-black text-[12px] list-disc px-5 space-y-2 md:space-y-4 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              ...
              <li>A Level Certificate (Completing 12 years of formal schooling. Diploma not accepted)</li>
              <li>
               ...
               <li>
               Any Bachelor's Degree with 36 months of executive work experience (supported by Employer issued documents)
               </li>
            </ul>
          </div>
        </div>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
                                          ...
                                          <div className="max-w-6xl mx-auto relative">
                                            ...
                                            >
                                              The Amity University Online MCOM follows a structured and
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for AMITY Online MCOM
              </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <p className="text-[#3C3C43] max-w-[350px] text-base">
              Master of Commerce is a 2-year (4 semesters) program that aims to equip the graduates and working professionals with the requisite knowledge and skills in Financial Management. The program helps you gain knowledge of conventional general principles and financial management traits.
            </p>

            {/* IMAGE that appears ONLY on mobile, above CTA */}
            <div className="md:hidden flex justify-center">
              <img
                src="/amity/degree/amityMcomDegree.png"
