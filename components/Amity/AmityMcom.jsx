      ...
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
            Boost your global career with India’s first UGC-approved Online M.Com. Gain expertise in finance, marketing, and accounting with guidance from international faculty.  </motion.p>
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-7xl text-left mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal text-[40px] leading-snug text-gray-900">
            ...
            Build expertise in finance, marketing, and accounting, study with international faculty, and develop strong analytical and leadership skills for top roles. </h2>
        </div>
          ...
          <h2 className="text-3xl md:text-[64px] font-bold text-[#345895] mb-7">
           ...
           <ul
             className="text-[#1F284E] text-[32px] px-5 list-disc mb-5 space-y-4 leading-tight">
                <li>Fresh graduates or final year students seeking a career in the finance domain.</li>
             <li> Graduation Degree (3 years or 4 years degree program only, Diploma will not be acceptable) </li>
              <li>Entrepreneurs who want to improve their financial management skills and update their knowledge of statistics, law and other financial aspects.
              </li>
                <li>Professionals who want to explore career opportunities in private/public sector organizations and government departments in industries including Financial Services, Insurance, Infrastructure, Banking and many more as Finance Manager, Banking Officer, Financial/ Insurance Advisor, and Finance Controller, among others.</li>
            <li>Applicants must possess sufficient knowledge and understanding of the English Language.</li>
            </ul>
          {/* for Indian Students */}
          <div className="mb-5">
            ...
            <ul
             ...
             <li>Graduation Degree (3 years or 4 years degree program only)
                </li> 
                <li>
A Diploma will not be acceptable.
          ...
          <div className="mb-5">
            ...
            <ul className="text-[#1F284E] text-[32px] mb-5 space-y-4 list-disc px-5 leading-tight">
              <li>O Level Certificate (Completing 10 years of formal schooling. Diploma not accepted)</li>
  ...
  <Link href="https://aiu.ac.in/" target="_blank" className="text-inherit hover:text-[#345895]">
    http://aiu.ac.in/
              ...
              <li>Any Bachelor's Degree with 36 months of executive work experience (supported by Employer issued documents)</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Amity University Online M.COM follows a structured and transparent examination process designed to evaluate learners through continuous assessments and end-term evaluations.
          </motion.p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
            ...
            <h2 className="text-[#345895] text-[46px] md:text-[52px] lg:text-[62px] font-bold leading-[1.05] max-w-[720px]">
              ...
              <span className="block">Online M.COM</span>
