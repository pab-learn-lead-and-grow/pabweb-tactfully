            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div>
                  ...
                  <p className="text-[#C4C4C4] font-bold text-[22px] mt-3">B.Com (Hons)</p>
...
const topicsData = {
 1:{
  ...
  5: [
    ...
    "Summer Internship (Domain Elective V: Choose any 2)",
  ...
  6: [
    "Strategic Business Leader III",
    "Fundamentals of Financial Analytics",
    "Dissertation (Non ACCA Track: Domain Elective VI - Choose any 2)",
    "Entrepreneurship Development",
    "Spreadsheet Modelling in Business",
    "E-Commerce & its Applications"
  ]
}
  ...
  const [isModalOpen, setIsModalOpen] = useState(false);
   ...
   const faqs = [
   {
  q: "What is the duration and format of the Online B.Com (Honours)?",
  a: "The program spans 3 years (6 semesters) and is delivered fully online, allowing you to complete lectures, assignments, and exams through a digital learning platform.",
},
{
  q: "What are the eligibility criteria for admission?",
  a: "Applicants must have completed 10+2 (or equivalent) from a recognised board, with a minimum percentage as required by the university to qualify for the B.Com (Honours) program.",
},
{
  q: "Is the Online B.Com (Honours) degree recognised and valid like a regular degree?",
  a: "Yes. Amity Online's B.Com (Honours) is UGC-entitled and recognised under the online education framework, making the degree valid for employment or higher education.",
},
{
  q: "Can working professionals or students with other commitments enroll in this program?",
  a: "Yes. The flexible, fully online structure allows learners to balance studies with work or other personal commitments.",
},
{
  q: "What does the curriculum cover - which skills and subjects will I study?",
  a: "The B.Com (Honours) curriculum covers key areas such as accounting, finance, economics, business law, and management principles, helping students build strong commercial, analytical, and financial skills.",
},
  ];
      ...
      <section className="relative min-h-screen lg:min-h-[50vh] xl:min-h-screen w-full ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-white text-[16px] mt-10 italic font-light"
          >
           UG Progam
          </motion.p>
          ...
          <div className="flex flex-col items-start">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-gray-200 text-left text-[16px] md:text-[18px] mt-0 mb-10 leading-relaxed"
            >
       Accelerate your career in finance with a UGC-approved Online B.Com (Hons). Gain essential business knowledge and graduate job-ready.
        </motion.p>
...
`}
      ...
      <section className="w-full bg-white p-10 py-12 flex flex-col lg:mb-20 gap-12">
        ...
        <div className="max-w-6xl text-left mx-auto">
          ...
          Prepare for high-growth careers in accounts and finance with a UGC-entitled Online B.Com (Hons).{" "} 
           </span>
           Master essential business and economic concepts, learn from distinguished international faculty, and graduate fully equipped to thrive in a dynamic job market.
           </h2></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            Experience a truly global education with renowned faculty
            </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-center">
            <div className="max-h-[400px] w-[90%]">
              <div className="flex flex-col w-full h-[180px] overflow-y-auto no-scrollbar gap-4 mt-35 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    key={sub.id}
                    onClick={() => {
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col gap-4 w-full h-[190px] overflow-y-auto no-scrollbar xl:w-[90%]">
              {semesters.map((sem) => (
                <motion.button
                  key={sem}
                  onClick={() => setActiveSemester(sem)}
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-8 w-[90%] bg-[#F6A104] text-white px-2 py-3 rounded-2xl  shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-12">
        <div className="p-6 md:p-10">
          ...
          <ul className="text-black text-[12px] space-y-2 md:space-y-4 list-disc px-5 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
            <li>
          Completion of 10+2 with a minimum of 55% marks.
          </li>         
          </ul>
          {/* for Indian Students */}
          <div className="mb-5">
          <h3 className="text-[20px] md:text-3xl lg:text-5xl italic text-[#3C087E] mb-2 md:mb-4">
            ...
            <ul className="text-black text-[12px] list-disc px-5 space-y-2 md:space-y-4 md:text-2xl xl:text-[32px] mb-2 md:mb-5 leading-tight">
              <li>Completion of 10+2 with a minimum of 55% marks.
                </li>  
      </ul>
          </div>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
                                         ...
                                         <div className="max-w-6xl mx-auto relative">
                                           ...
                                           >
                                             The Amity University Online BCom Honours follows a structured and
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-20">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-[#270652] text-[32px] md:text-[40px] lg:text-[64px] font-bold leading-tight">
              Amity University
              <br />
              Online B.COM Honours Certificate
            </h2>

            <p className="text-[#3C3C43] max-w-[350px] text-base">
       Bachelor of Commerce (Hons) is a 3-year (6 semesters) undergraduate program designed to develop the business acumen, financial literacy, and analytical skills of the learners.
        </p>

            {/* IMAGE that appears ONLY on mobile, above CTA */}
            <div className="md:hidden flex justify-center">
              <img
                src="/amity/degree/amityBcomHonsDegree.png"
