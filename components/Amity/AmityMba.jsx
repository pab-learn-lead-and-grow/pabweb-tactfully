                       ...
                       <div className="flex flex-col gap-4 w-full xl:w-[90%]">
                         {semesters.map((sem) => (
                          ...
                          <motion.button
                            whileHover={{ scale: 1.05 }}
                            onClick={() => setIsModalOpen(true)}
                            className=" w-full bg-[#F6A104] text-white px-4 py-4 rounded-2xl shadow-md flex items-center justify-center gap-4"
                          >
                            DOWNLOAD SYLLABUS
       ...
       <section className="w-full flex items-center justify-center px-6 md:px-18">
             <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-20">
               ...
               <div className="space-y-5">
                 ...
                 {/* CTA BUTTON */}
                 <button onClick={() => setIsModalOpen(true)} className="bg-[#F6A104] text-white font-medium text-sm px-10 py-2 rounded-lg transform hover:scale-105 duration-200 flex items-center justify-center">
                   Know more
                 </button>
               </div>
