    ...
    <main className="flex flex-col items-center w-full bg-white">
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              A high-impact blend of academic depth, AI-powered tools, and
              practical projects that equip you for real-world industry
              challenges.
              <br />
              Experience personalized learning, 24/7 mentorship, and advanced
              simulations built to help you succeed in a digital-first business
              landscape.
            </motion.p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
              viewport={{ once: true }}
              className="grid grid-cols-2 mt-5 md:grid-cols-4 -mx-8 gap-y-6 w-7xl"
            >
              {stats.map((stat, idx) => (
                <div
                  key={idx}
        ...
        <div className="max-w-7xl text-left mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal text-[40px] leading-snug text-gray-900">
            <span className="text-[#F9BD04] ">
              A powerful combination of academic rigor, AI-driven tools, and
              hands-on projects that prepare you for real industry challenges.{" "}
            </span>
            Benefit from personalized learning, round-the-clock mentorship, and
            advanced simulations designed to help you thrive in today's
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Engage in real industry projects and solve actual business
                challenges with guidance from industry experts. Build practical
                experience, earn project-specific certifications, and
                demonstrate your capabilities to recruiters before you graduate.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6 rounded-xl bg-[rgba(6,78,146,0.02)] hover:bg-[rgba(6,78,146,0.05)] shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <div>
              ...
              <ul className="px-5 py-1 list-disc text-gray-700 text-sm leading-tight">
                <li>Quick summaries for immediate clarity</li>
                <li>Auto-generated practice questions</li>
                <li>A built-in tool to capture and organize notes</li>
              </ul>
              <p className="text-gray-700 text-sm leading-relaxed">
                Everything you need is unified in one intuitive platform, so you
                can concentrate fully on mastering your lessons.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Amity University Online MBA follows a structured and transparent
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
            ...
            <p className="text-[#3C3C43] max-w-[530px] text-base leading-relaxed">
              ...
              will not only cover modern tools and practices but will also
              provide you with the ability to manage critical business
              decisions.
            </p>
