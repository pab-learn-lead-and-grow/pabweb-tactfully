...
export default function Page() {
  ...
  const faqs = [
  {
  q: "What is the duration and format of the IF&A program?",
  a: "The program runs for 3 years (6 semesters) and is delivered fully online, allowing students to study flexibly from anywhere.",
},
{
...
{
  q: "Is the degree recognized, and does it offer ACCA accreditation/exemptions?",
  a: "Yes, the IF&A specialization is accredited by ACCA (UK), providing global recognition and offering up to 9 ACCA paper exemptions.",
},
{
  q: "What does the curriculum cover — what subjects and skills will I learn?",
  a: "The curriculum covers key areas such as financial accounting, corporate law, taxation, auditing & assurance, cost accounting, international financial management, business mathematics, financial reporting, and ethics & corporate governance, aligned with global accounting standards.",
},
{
  q: "Can I pursue this degree while working or handling other commitments?",
  a: "Yes, the fully online format with live and recorded lectures, digital resources, and flexible scheduling makes it ideal for working professionals and learners with other responsibilities.",
},
  ];
  ...
  return (
    <main className="flex flex-col items-center w-full bg-white">
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        {/* CONTENT WRAPPER */}
        <div className="relative z-10 max-w-8xl mx-auto p-6 sm:p-10">
          {/* Subtext */}
          <motion.p
          ...
          <div className="flex flex-col items-start">
            ...
            >
      An ACCA-accredited B.Com that builds strong global finance and accounting skills. Gain eligibility for 9 ACCA exam exemptions and prepare for careers in audit, taxation, financial management, and corporate reporting.
       </motion.p>
            {/* STATS */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              ...
              transition={{ duration: 0.7 }}
              viewport={{ once: true }}
              className="grid grid-cols-2 mx-25 mt-5 md:grid-cols-4 gap-y-6 w-7xl"
            >
              {stats.map((stat, idx) => (
                <div
                  key={idx}
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-6xl text-left mx-auto">
          ...
          This ACCA-accredited B.Com in International Finance & Accounting equips you with advanced financial and accounting skills, shaping you into a globally ready finance professional.{" "}
           </span>
           With strong technical training and strategic thinking development, you can pursue careers in audit, corporate reporting, financial management, taxation, governance, and more. Earn 9 ACCA exam exemptions and fast-track your journey toward international finance roles.
           </h2>
        </div>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Amity University Online B.COM International Finance & Accounting follows a structured and
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[60%_40%] items-center font-[Inter] gap-6">
          ...
          <div className="space-y-4 pr-4">
            ...
            <h2 className="text-[#345895] text-[46px] md:text-[52px] lg:text-[62px] font-bold leading-[1.05] max-w-[720px]">
              ...
              <span className="block">International<br />
               Finance & <br />
               Accounting</span>
