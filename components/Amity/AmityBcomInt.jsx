              ...
              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                ...
                <div className="flex flex-col items-start">
                  ...
                  as="h1"
                    ...
                    viewport={{ once: true }}
                    className="text-white text-[20px] md:text-4xl lg:text-[44px] xl:text-[56px] font-sans font-bold mt-1 leading-tight"
                  >
...
/>
      ...
      <section className="w-full font-sans px-4 md:px-10 lg:px-20 py-10">
