...
const topicsData = {
  ...
  return (
              ...
              <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                ...
                <div className="flex flex-col items-start">
                  <motion.h1
                    ...
                    viewport={{ once: true }}
                    className="text-white text-[20px] md:text-4xl lg:text-[44px] xl:text-[64px] font-[Inter] font-bold mt-1 leading-tight"
                  >
                    AMITY Online B.Com in International Finance and Accounting
                  </motion.h1>
    ...
    <>
      Why Choose AMITY <br />
      Online BCOM  Int. Finance & Accounting
    </>
  } cards={whyCards} onCtaClick={() => setIsModalOpen(true)} />

      <section className="w-full bg-white px-4 md:px-16 pt-10 lg:pt-20">
        {/* Title */}
        <motion.h2
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          AMITY Online BCOM<br/>
          Int. Finance & Accounting Syllabus
        </motion.h2>
          ...
          <div className="hidden xl:flex w-[30%] flex-col items-start xl:items-center mt-10">
            <div className="flex flex-col h-[190px] overflow-y-auto no-scrollbar gap-4 w-full xl:w-[90%]">
             ...
             <motion.button
                whileHover={{ scale: 1.05 }}
                onClick={() => setIsModalOpen(true)}
                className="mt-8 w-[90%] bg-[#F6A410] text-white px-2 py-3 rounded-2xl shadow-md flex items-center justify-center gap-4"
              >
                DOWNLOAD SYLLABUS
      ...
      <section className="w-full font-[Inter] px-4 md:px-10 lg:px-20 py-10">
        <div className="p-6 md:p-10">
          {/* Heading */}
          <h2 className="text-[32px] sm:text-4xl md:text-[54px] lg:text-[64px] font-bold text-[#270652] mb-4 md:mb-7">
            Eligibility for BCOM in International Finance & Accounting
          </h2>
      ...
      />
       ...
       <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
                                          ...
                                          <div className="max-w-6xl mx-auto relative">
                                            ...
                                            >
                                              The Amity University Online BCOM International Finance and Accounting follows a structured and
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for BCOM in International Finance & Accounting
              </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center font-[Inter] lg:gap-10">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-[#270652] text-[32px] md:text-[40px] lg:text-[64px] font-bold leading-tight">
              Amity University<br /> 
              Online B.COM International Finance & Accounting Certificate
            </h2>
  ...
  >
    Know more
      ...
      <section className="w-full bg-white lg:py-20 md:px-12 lg:px-20">
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 lg:py-16">
        {/* TITLE */}
