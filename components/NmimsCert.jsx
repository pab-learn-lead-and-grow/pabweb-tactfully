        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-start gap-10">
          ...
          <div className="flex lg:justify-end justify-start lg:items-start items-center">
            <motion.button
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="bg-linear-to-r from-[#4D964F] to-[#193019] border-0 border-transparent shadow-[#1C361D] shadow-md transform hover:scale-105 duration 200 px-6 py-3 mt-10 lg:mt-65 rounded-lg text-sm md:text-base font-semibold whitespace-nowrap"
            >
              DOWNLOAD SYLLABUS →
            </motion.button>
          </div>
