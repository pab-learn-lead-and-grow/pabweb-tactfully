...
export default function Page() {
  ...
  const faqs = [
 {
    q: "Is the Online BBA from JAIN Online recognized and valid?",
    a: "Yes. The Online BBA degree from JAIN Online is UGC-entitled and delivered under approved online education regulations.",
  },
  {
    q: "Who is eligible to apply for the Online BBA program?",
    a: "Students who have passed 10+2 (or equivalent) from a recognized board are eligible to apply. There is typically no strict age limit.",
  },
  {
    q: "What is the duration and structure of the Online BBA?",
    a: "The program is 3 years long, structured in semesters. Electives and specializations are indicated at the time of admission.",
  },
  {
    q: "Is the BBA program completely online? Do I need to visit campus?",
    a: "Yes — the program is offered fully online via a Learning Management System (LMS), with access to lectures, study materials, and resources from anywhere.",
  },
  {
    q: "Can working professionals or students already in a job enrol while working?",
    a: "Yes. The flexible online format makes it feasible to continue working while studying.",
  },
  ];
...
const topicsData = {
  ...
  3: {
    1: [
      ...
      "Business Foundations with Excel",
    ...
    5: [
      "Content Marketing",
      "Marketing Analytics",
      "Web, Mobile, and Social Media Analytics",
      "Research Methodology",
  ...
  >
    ...
    <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
      ...
      With more than three decades of academic excellence and cutting-edge, technology-driven learning systems, we focus on both academic achievement and personal growth to ensure holistic development. Supported by experienced faculty and digital learning experts, our flexible online platform allows learners to study anytime, anywhere, and at their own pace.
                   ...
                   <div className="max-w-6xl text-left mx-auto">
                     <h2 className="text-xl md:text-2xl font-regular lg:text-[36px] leading-normal text-gray-900">
                       <span className="text-[#002153] ">
                        Advance your career with our Online BBA Program.{" "}</span>
                    Designed with an industry-focused curriculum and a flexible learning structure, this program equips you with the skills needed to succeed in today’s fast-changing business landscape. Choose the elective that aligns with your goals and enroll today.
                     </h2>
                   </div>
            ...
            <WhyChooseUs title="Why Choose JAIN Online BBA" cards={whyCards} />
      
          <SyllabusSection
  title="JAIN Online BBA Syllabus"
  subjects={subjects}
  semesters={semesters}
  semSuffix={semSuffix}
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
            ...
            >
              ...
              <h2 className="text-3xl md:text-[64px] font-bold text-[#270652] mb-7">
                Eligibility for JAIN Online BBA
              </h2>
            ...
            />
               ...
               <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-sans relative">
                                                  ...
                                                  <div className="max-w-6xl mx-auto relative">
                                                    ...
                                                    >
                                                      The Jain University Online BBA follows a structured and
                          ...
                          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
                            ...
                            <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
                              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                                Fees Structure for JAIN Online BBA
                              </h2>
