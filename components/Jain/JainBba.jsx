...
With more than three decades of academic excellence and cutting-edge, technology-driven learning systems, we focus on both academic achievement and personal growth to ensure holistic development. Supported by experienced faculty and digital learning experts, our flexible online platform allows learners to study anytime, anywhere, and at their own pace.
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-7xl text-left mx-auto">
         ...
         Advance your career with our Online BBA Program.{" "}
           </span>
  ...
  <div className="flex flex-col gap-10 max-w-7xl">
    ...
    >
      ...
      Build a strong foundation in business administration to qualify for entry-level roles across multiple industries.
      </p>
    </motion.div>
    ...
    >
      ...
      Strengthen key leadership, teamwork, and decision-making skills to prepare for future management positions.
      </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] max-w-7xl leading-tight">
      Develop a solid understanding of marketing concepts for opportunities in sales, advertising, or brand management.
      </p>
    </motion.div>
    ...
    >
     ...
     Gain essential financial management knowledge suited for careers in accounting, finance, or entrepreneurial ventures.
       </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] max-w-7xl leading-tight">
       Enhance your employability through hands-on projects or internships that offer real-world business experience.
       </p>
    </motion.div>
