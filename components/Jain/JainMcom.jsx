          ...
          <section className="relative min-h-[50vh] w-full ">
                             ...
                             <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                               ...
                               <div className="flex flex-col items-start">
                                 ...
                                 >
                                Advance your career with our Online M.Com - an industry-aligned, flexible program that builds the expertise needed to excel in today’s competitive commerce landscape, with electives tailored to your goals. </motion.p>
                          ...
                          : "bg-white text-black border-2 border-dashed border-[#3C087E]"
                                ...
                                <div className="hidden xl:flex w-[30%] flex-col items-center">
                                  <div className="max-h-[400px] w-[90%]">
                                    <div className="flex flex-col w-full h-[350px] overflow-y-auto no-scrollbar gap-4 mt-25 items-center">
                                      {subjects.map((sub) => (
                                        <motion.button
                                          key={sub.id}
                                          onClick={() => {
