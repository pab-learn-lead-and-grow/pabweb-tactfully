...
export default function Page() {
  ...
  const faqs = [
{
  q: "Is the Online M.Com from JAIN Online recognized and valid?",
  a: "Yes. The M.Com program at JAIN Online is UGC-entitled and follows the norms for online education. Degrees awarded through this program are equivalent to on-campus degrees.",
},
{
  q: "Who is eligible to apply for the Online M.Com program?",
  a: "You must hold a bachelor's degree (minimum 3-year duration) from a UGC-recognized university. Graduates from any discipline are eligible.",
},
{
  q: "What is the duration and structure of the Online M.Com program?",
  a: "The program lasts for 2 years and is structured over 4 semesters. It includes core coursework and offers elective or specialization options.",
},
{
  q: "When do electives or specializations begin in the program?",
  a: "Electives or specializations begin as per the course handbook. For postgraduate programs like M.Com, the semester-wise structure determines when specialization subjects are introduced.",
},
{
  q: "Is the course delivery fully online? Do I need to visit campus?",
  a: "Yes — the program is delivered entirely online through a Learning Management System (LMS), allowing you to study from anywhere at any time with no campus visits required.",
}
  ];
  ...
  { id: 1, name: "Accounting & Finance" },
   { id: 2, name: "Professional Accounting & Finance" },
    { id: 3, name: "International Finance" },
];
...
const topicsData = {
  1: {
    ...
    3: [
      "Introduction to FinTech and Analytics",
      "GST and Customs Law",
  ...
  2: {
    ...
    3: [
      ...
      "Technical Accounting & Reporting - II",
    ...
    4: [
      "Business Law - II",
      "Technical Accounting & Reporting - III",
      ...
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
   Advance your career with our Online M.Com-an industry-aligned, flexible program that builds the expertise needed to excel in today’s competitive commerce landscape, with electives tailored to your goals.
   </motion.p>
            {/* STATS */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
...
With more than three decades of academic excellence and cutting-edge, technology-driven learning systems, we focus on both academic achievement and personal growth to ensure holistic development. Supported by experienced faculty and digital learning experts, our flexible online platform allows learners to study anytime, anywhere, and at their own pace.
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-7xl text-left mx-auto">
         ...
         Advance your career with our Online M.Com Program.{" "}
           </span>
         Featuring an industry-relevant curriculum and a flexible learning structure, this program equips you with the knowledge and expertise needed to excel in today’s competitive commerce landscape. Choose the elective that aligns with your goals and enroll today.
        </h2>
        </div>
        ...
        >
          ...
          <div className="w-full lg:w-[30%] flex flex-col items-center">
            <div className="max-h-[400px] md:w-[90%] pr-2 overflow-y-auto scrollbar-hide">
              <div className="flex flex-col w-full gap-4 mt-20 items-center">
                {subjects.map((sub) => (
                  <motion.button
                    key={sub.id}
                    onClick={() => {
    ...
    <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Jain University Online M.COM follows a structured and
      ...
      <section className="w-full font-[Inter] mt-20 flex items-center justify-center">
        ...
        <div className="px-2">
          ...
          <div className="flex flex-row justify-center items-center gap-10">
            ...
            {/* RIGHT SIDE CARDS */}
            <div className="flex flex-row items-start justify-center font-[Inter] gap-6 lg:w-[35%] pr-20">
              {/* Annual PAYMENT CARD */}
  ...
  <div className="flex flex-col gap-10 max-w-7xl">
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] mt-4 leading-tight">
       Build advanced financial management expertise to pursue roles in corporate finance or financial analysis.
         </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] max-w-7xl leading-tight">
       Strengthen your knowledge of accounting and auditing principles for careers in accounting, auditing, or taxation.
       </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] max-w-7xl leading-tight">
        Develop strong economic analysis skills suited for positions in economic research or policy development.
        </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[22px] max-w-7xl leading-tight">
        Gain a solid understanding of international business and trade for opportunities in global finance or international commerce.
          </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] max-w-7xl leading-tight">
       Enhance your business analytics capabilities to qualify for roles in business intelligence, analysis, or management consulting.
        </p>
    </motion.div>
