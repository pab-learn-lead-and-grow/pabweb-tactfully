...
export default function Page() {
  ...
  const faqs = [
{
  q: "Is the MA from JAIN Online a recognized and valid degree?",
  a: "Yes. The MA offered by JAIN Online is UGC-entitled under the approved online education framework and is delivered by a NAAC A++ graded institution.",
},
{
  q: "Who is eligible to apply for the Online MA program?",
  a: "Candidates who have completed a bachelor's degree (minimum three years) from a UGC-recognized university in any discipline are eligible. Final-year bachelor's students awaiting results may also apply.",
},
{
  q: "How long is the MA program and how is it structured?",
  a: "The program spans 2 years and is organized into 4 semesters. It includes core courses, specialization-based electives, and may involve a dissertation or project depending on the chosen specialization.",
},
{
  q: "What specializations or electives are offered under the Online MA program?",
  a: "JAIN Online offers electives such as English, Economics, Public Policy, Journalism & Mass Communication, and Comparative Religions & Philosophy (Jainology).",
},
{
  q: "Is the course delivery fully online? Do I need to visit campus?",
  a: "Yes. The entire curriculum is delivered online through JAIN’s Learning Management System (LMS), allowing students to study from anywhere with no mandatory campus visits.",
}
  ];
...
const subjects = [
  { id: 1, name: "Jainology & Comparative Religion and Philosophy" },
  { id: 2, name: "English" },
  { id: 3, name: "Economics" },
               ...
               <section className="relative min-h-[50vh] w-full ">
                                ...
                                <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
                                  ...
                                  <div className="flex flex-col items-start">
                                    ...
                                    >
                                    Elevate your journey with our Online MA Program - designed with an industry-relevant curriculum and flexible learning to help you succeed in the evolving world of arts and humanities. Customize your path with electives and enroll today.
                                     </MotionWrapper>
...
<CounsellingModal>
 ...
 <section className="w-full bg-white py-10 px-4 lg:px-10 pt-0">
      ...
      With more than three decades of academic excellence and cutting-edge, technology-driven learning systems, we focus on both academic achievement and personal growth to ensure holistic development. Supported by experienced faculty and digital learning experts, our flexible online platform allows learners to study anytime, anywhere, and at their own pace.
                    ...
                    <div className="max-w-6xl text-left mx-auto">
                      <h2 className="text-xl md:text-2xl font-regular lg:text-[36px] leading-normal text-gray-900">
                        <span className="text-[#002153] ">
                         Advance your career with our Online MA Program.{" "}</span>
                     Built on an industry-relevant curriculum and a flexible learning format, this program equips you to excel in the evolving fields of arts and humanities. Choose the elective that aligns with your goals and enroll today.
                     </h2>
                    </div>
             ...
             <WhyChooseUs title="Why Choose JAIN Online MA" cards={whyCards}  />
       
            <SyllabusSection
  title="JAIN Online MA Syllabus"
  subjects={subjects}
  semesters={semesters}
  semSuffix={semSuffix}
           ...
           <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
             ...
             >
               ...
               <h2 className="text-3xl md:text-[64px] font-bold text-[#270652] mb-7">
                 Eligibility for JAIN Online MA
               </h2>
             ...
             />
               ...
               <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-sans relative">
                                                                ...
                                                                <div className="max-w-6xl mx-auto relative">
                                                                  ...
                                                                  >
                                                                    The Jain University Online MA follows a structured and
                           ...
                           <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
                             ...
                             <div className="w-full lg:w-[45%] text-center lg:text-left flex flex-col justify-center">
                               <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                                 Fees Structure for JAIN Online MA
                               </h2>
                               ...
                               <CounsellingModal>
                                <button  className="hidden lg:flex text-white bg-[#F6A410] border-0 border-transparent font-medium px-6 py-2 rounded-md shadow-md transform hover:scale-105 duration-200 w-fit">
                                 Compare all Plans
                               </button>
                               </CounsellingModal>
                             </div>
    ...
    Know more
                    ...
                    />
                        ...
                        <section className="w-full bg-white py-10 lg:py-20 md:px-12 lg:px-20">
                          <div className="w-full md:bg-[#270652] rounded-4xl py-12 px-6 md:px-10 lg:px-15">
                            <MotionWrapper
             ...
             <section className="w-full px-4 md:px-10 lg:px-20 py-10">
               ...
               <div className="w-full overflow-hidden">
                 {/* HEADER ROW */}
                 <div className=" max-w-5xl flex items-center justify-center bg-[#D68E0E]/10 text-[#D68E0E] font-semibold text-center m-auto px-10 lg:px-30 py-8 text-[16px] md:text-[24px] rounded-xl">
                   <p>ADMISSION OPEN FOR JULY 26 SESSION</p>
                 </div>
               </div>
             </section>
