...
export default function Page() {
  ...
  const benefits = [
    {
      icon: <FileUser strokeWidth={1.0} className="text-[#F6A410] w-18 h-18" />,
    ...
    {
      icon: <Users strokeWidth={1.0} className="text-[#F6A410] w-18 h-18" />,
      ...
      <section className="relative min-h-[50vh] w-full ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              Accelerate your growth with our Online B.Com - an
      ...
      <section className="w-full bg-white p-10 py-12 flex flex-col lg:mb-20 gap-12">
        ...
        <div className="max-w-6xl text-left mx-auto">
          <h2 className="text-xl md:text-2xl font-regular lg:text-[36px] leading-normal text-gray-900">
            ...
            Designed with an industry-focused curriculum and a flexible learning
            format, this program equips you to thrive in the evolving field of
            commerce. Choose the elective that aligns with your goals and enroll
            today.
          </h2>
        </div>
          ...
          <div className="flex flex-col gap-4 p-4 sm:p-6">
            ...
            <div>
              ...
              <p className="text-gray-700 text-xs lg:text-[16px] leading-relaxed">
                400+ hours of recorded video lectures making, your learning
                journey convenient.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
            ...
            >
              ...
              <h2 className="text-3xl md:text-[64px] font-bold text-[#270652] mb-7">
                Eligibility for JAIN Online BCOM
              </h2>

              <ul className="text-black text-[20px] md:text-[24px] lg:text-[32px] px-5 list-disc mb-5 space-y-4 leading-tight">
                <li>
                  Pass in the (10+2) examination from State Board / CBSE / NIOS
                  / IGCSE/ IB / ICSE recognized by the State or Central
                  Government.
                </li>

                <li>
                  Candidates who are due to appear in the (10+2) examination are
                  also eligible to apply for an Online BBA in Human Resource
                  Management Program.
                </li>
              </ul>
            </MotionWrapper>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] text-left flex flex-col justify-center">
              <h2 className="text-[#270652] text-[42px] md:text-[52px] lg:text-[64px] font-bold leading-[110%] mb-4 md:mb-10">
                Fees Structure for JAIN Online BCOM
              </h2>
              ...
              <ul className="text-gray-700 text-sm md:text-base list-disc px-5 leading-tight md:mb-10">
                <li>
                  {" "}
                  Professional fee will be applicable during the 1st and 3rd and
                  5th semesters.
                </li>
                <li>
                  One time university registration fee during Admission:
                  ₹2,500/-{" "}
                </li>
                <li>Examination Fee per year: ₹3,000/-For SAARC countries,</li>
                <li>
                  Registration Fee Per Year: ₹ 11,250/- and Exam Fee Per Year: ₹
                  3,750/-
                </li>
                <li>
