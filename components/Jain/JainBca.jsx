...
const faqs = [
 {
  q: "Is the Online BCA from JAIN Online University recognised and valid?",
  a: "Yes. The Online BCA offered by JAIN Online is UGC-approved and delivered under the official online-education regulations, making it fully valid for employment and higher education."
},
{
  q: "Who is eligible to apply for the Online BCA program?",
  a: "Anyone who has completed 10+2 (or equivalent) from a recognised board is eligible to apply for the Online BCA program."
},
{
  q: "What is the duration and structure of the Online BCA?",
  a: "The Online BCA is a 3-year undergraduate programme structured across 6 semesters, covering core computer applications, programming, databases, networking, and practical lab work."
},
{
  q: "What specializations or electives are available under Online BCA?",
  a: "JAIN Online offers specializations such as Computer Science & IT, Cyber Security, Data Analytics, Cloud Computing & Information Security, and others depending on batch availability."
},
{
  q: "Is the program fully online? Do I need to visit campus?",
  a: "Yes. The BCA program is delivered entirely online through a Learning Management System (LMS), providing access to live and recorded classes, study materials, labs, and assignments from anywhere with no campus visits required."
}
...
const topicsData = {
  ...
  1: {
    1: [
      ...
      "Digital Fluency and Financial Modeling",
      ...
      <section className="relative min-h-[650px] md:min-h-[750px] w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10">
          ...
          <div className="flex flex-col items-start">
            ...
            >
  Unlock your potential with our Online BCA—an industry-aligned, flexible program that builds the technical skills needed to thrive in today's competitive tech landscape.
   </motion.p>
...
With more than three decades of academic excellence and cutting-edge, technology-driven learning systems, we focus on both academic achievement and personal growth to ensure holistic development. Supported by experienced faculty and digital learning experts, our flexible online platform allows learners to study anytime, anywhere, and at their own pace.
      ...
      <section className="w-full bg-white px-2 md:px-12 lg:px-20 py-12 flex flex-col gap-8">
        ...
        <div className="max-w-7xl text-left mx-auto">
         ...
         Advance your career with our Online BCA Program.{" "}
           </span>
     Designed with an industry-relevant curriculum and a flexible learning structure, this program equips you with the skills needed to succeed in today’s competitive technology landscape.
     </h2>
        </div>
    ...
    <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10">
      ...
      >
        ...
        <ul className="text-[#1F284E] text-[24px] md:text-[28px] lg:text-[32px] px-5 list-disc mb-5 space-y-4 leading-tight">
          ...
          <li>
           Candidates who are due to appear in the (10+2) examination are also eligible to apply for an Online BCA Program in any specialization.
          </li>
        </ul>
      </motion.div>
      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-10 font-[Inter] relative">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            The Jain University Online BCA follows a structured and
      ...
      <section className="w-full font-[Inter] mt-20 flex items-center justify-center">
        ...
        <div className="px-2">
          ...
          <div className="flex flex-row justify-center items-center gap-10">
            ...
            <div className="w-full lg:w-[45%] flex flex-col justify-center">
              <h2 className="text-[#064E92] text-[42px] md:text-[52px] font-extrabold leading-[110%] mb-6">
               ...
               <div className="text-black">
                One time university registration fee during Admission:₹2,500/-<br/> Examination Fee per year: ₹3,000/-<br />For SAARC countries, Registration Fee Per Year: ₹ 11,250/-<br/> and Exam Fee Per Year: ₹ 3,750/-<br />Fee applicable to students from India and SAARC<br/> countries only
              </div>
            ...
            {/* RIGHT SIDE CARDS */}
            <div className="flex flex-row items-center justify-center font-[Inter] gap-6 lg:w-[35%] mx-20 pr-15">
              {/* Annual PAYMENT CARD */}
              <div className="bg-linear-to-b from-[#345895] to-[#101C2F] border rounded-xl shadow-sm px-6 py-8 w-[100px] md:w-[230px] flex flex-col justify-between h-[260px]">
                ...
                <p className="text-2xl md:text-2xl text-white text-center mb-8">
                  ₹1,35,000/-
                </p>
              </div>
              {/* Semester wise CARD */}
  ...
  <div className="flex flex-col gap-10 max-w-7xl">
    ...
    Build a strong foundation in computer applications to qualify for entry-level roles in the IT sector.
</p>
    </motion.div>
    ...
    Strengthen essential skills in programming, software development, and database management for more advanced technical positions.
     </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] max-w-7xl leading-tight">
   Develop solid knowledge of web development and cybersecurity concepts for careers in IT support, web design, or security analysis.
    </p>
    </motion.div>
   ...
   Gain competency in data analytics and machine learning to pursue opportunities in data science and AI-related roles.
   </p>
    </motion.div>
    ...
    >
      ...
      <p className="text-black text-[16px] md:text-[24px] max-w-7xl leading-tight">
     Enhance your practical abilities through hands-on projects and internships, preparing you for real-world challenges in the tech industry.
     </p>
    </motion.div>
  </div>
</section>
      ...
      <section className="w-full bg-white py-20 px-16 md:px-12 lg:px-20">
        <div className="w-full bg-[#064E92] rounded-4xl py-20 px-16 md:px-12 lg:px-20">
          ...
          >
            {/* Title */}
            <div className="text-center mb-3 relative pb-3">
              <motion.h2
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className="text-[#064E92] font-extrabold font-[Inter] text-3xl md:text-5xl lg:text-[64px]"
              >
            ...
            <motion.p
              ...
              className="text-center text-[20px] flex justify-center text-black max-w-lg mx-auto mb-12"
            >
