    ...
    <main className="flex flex-col items-center w-full bg-white">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6 px-4 md:px-12 items-center">
          <div>
            <h1 className="text-[28px] md:text-4xl lg:text-[40px] text-center md:text-left font-bold text-[#270652] mb-4">
              Online M.Com in India 2026: Top Colleges, Fees, Admission &
              Eligibility
            </h1>

            <p className="text-black leading-relaxed text-center md:text-left text-xs lg:text-[18px] mb-10">
              Online MCom programs have gained significant popularity in recent
              years, offering flexible learning opportunities for graduates and
              working professionals alike. These programs are designed to
              deliver advanced commerce and financial knowledge through digital
              platforms, combining live sessions with recorded content. Learners
              can develop expertise in areas such as accounting, finance,
              taxation, and business management while balancing professional and
              personal commitments. Additionally, online MCom programs emphasize
              practical exposure through projects, case studies, and real-world
              applications, helping students enhance analytical skills and
              advance their careers in a competitive business environment.
            </p>

            <p className="text-black leading-relaxed text-center md:text-left text-xs lg:text-[18px] mb-10">
              Online MCom programs typically have a duration of 2 years,
              structured into 4 semesters, making them suitable for graduates
              seeking specialization in commerce and finance. These programs are
              ...
              learners gain deeper expertise in core commerce subjects along
              with advanced electives, enabling better career opportunities in
              finance, accounting, and academic or professional domains.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-4 text-[#4B5563] text-base lg:text-xl leading-relaxed max-w-xl">
              <p>
                An Online MCom is ideal for graduates who want to gain advanced
                knowledge in commerce, accounting, and finance without
                compromising on flexibility. It provides in-depth subject
                expertise, analytical skills, and quality education for learners
                aiming to strengthen their professional and academic careers.
              </p>

              <p>
                Whether you aim to pursue careers in finance, accounting,
                taxation, or academics, or prepare for professional
                certifications and higher studies, an Online MCom equips you
                with the knowledge and confidence to achieve your goals.
              </p>
            </div>
      ...
      <section className="py-12 px-4 lg:px-20">
        ...
        >
          ...
          >
            <p>
              Bachelor’s degree in Commerce or related field from a recognized
              university with minimum required marks as per university
              guidelines.
            </p>
          </MotionWrapper>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-[#4B5563] text-base lg:text-xl leading-relaxed max-w-xl">
                <p>
                  Online MCom opens doors to advanced career opportunities in
                  finance, accounting, taxation, and corporate sectors, where
                  specialized knowledge and analytical skills are highly valued.
                </p>

                <p>
                  Graduates can pursue roles in financial management, auditing,
                  banking, or academics, and also prepare for professional
                  certifications like CA, CMA, or CFA to further enhance their
                  career prospects.
                </p>
              </div>
            </div>
      ...
      <section className="bg-white py-12 lg:py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="space-y-4 text-[#4B5563] text-base lg:text-xl leading-relaxed">
            <p>
              The future of Online MCom is highly promising as the demand for
              specialized finance and commerce professionals continues to grow
              across industries. With the expansion of corporate finance,
              banking, taxation, and global business sectors, MCom graduates
              gain access to advanced and high-growth career opportunities in
              the evolving economic environment.
            </p>

            <p>
              Online MCom programs are evolving to include research-based
              learning, practical financial applications, and industry-relevant
              tools, making graduates career-ready for senior roles. As
              organizations increasingly value advanced knowledge and analytical
              expertise, Online MCom graduates are well-positioned to secure
              roles in finance, corporate sectors, or pursue professional
              certifications like CA, CMA, or CFA for specialized career growth.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* LEFT SIDE */}
